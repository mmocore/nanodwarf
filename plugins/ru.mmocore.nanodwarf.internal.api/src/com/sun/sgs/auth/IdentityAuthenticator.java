...
/**
 * This interface is used to define modules that know how to authenticate an
 * identity based on provided credentials. The credentials must be of a form
 * recognizable to the implementation. Note that each application context has
 * its own instances of <code>IdentityAuthenticator</code>s. Typically
 * implementations of <code>IdentityAuthenticator</code> are invoked by a
 * containing <code>IdentityManager</code>.
 * <p>
 ...
 * <p>
 * FIXME: When the IO interfaces are ready, these should also be provided to the
 * constructor.
 */
