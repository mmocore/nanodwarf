...
/**
 * Provides profiling detail about a {@code TransactionListener} that listened
 * to the progress of a transaction.
 */
public interface TransactionListenerDetail {
	...
	/**
	 * Returns whether the listener's {@code beforeCompletion} method was
	 * called.
	 * 
	...
	/**
	 * Returns whether the listener's {@code beforeCompletion} method threw an
	 * exception thus aborting the transaction.
	 * 
	 * @return {@code true} if the listener's {@code beforeCompletion} method
