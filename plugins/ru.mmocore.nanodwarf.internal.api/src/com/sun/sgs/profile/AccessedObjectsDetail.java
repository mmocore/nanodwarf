...
public interface AccessedObjectsDetail {
	...
	static enum ConflictType {
		...
		DEADLOCK,
		/**
		 * Some requested access was not granted, e.g. due to timeout or a lock
		 * being unavailable.
		 */
		ACCESS_NOT_GRANTED,
	...
	/**
	 * The collection of requested object accesses. The order is the same as the
	 * order in which the objects were requested in the transaction.
	 * 
	 ...
	 *         or {@code null} if there was no conflict or the accessor is
	 *         unknown
	 */
