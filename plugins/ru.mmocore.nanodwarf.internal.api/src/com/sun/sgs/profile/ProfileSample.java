 ...
 * {@link ProfileConsumer#createSample ProfileConsumer.createSample}. A sample's
 * name includes both the {@code name} supplied to {@code createSample} and the
 * value of {@link ProfileConsumer#getName}.
 */
