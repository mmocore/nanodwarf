 ...
 * obtained by registering an access source with a single
 * {@link AccessCoordinator} using the same source name, and the values returned
 * by {@link #getObjectId()} and {@link #getAccessType()} are equal.
 */
