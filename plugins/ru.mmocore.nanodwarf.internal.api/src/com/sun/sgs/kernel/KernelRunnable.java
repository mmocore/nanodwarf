...
/**
 * This is the base interface used for all tasks that can be submitted to
 * instances of <code>Scheduler</code>.
 */
public interface KernelRunnable {
	 ...
	 * <code>ExceptionRetryStatus</code> then the <code>Scheduler</code> will
	 * consult the <code>shouldRetry</code> method of the <code>Exception</code>
	 * to see if this task should be re-run.
	 * 
	 * @throws Exception
	 *             if any error occurs
	 */
