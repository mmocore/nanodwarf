...
public interface DataServiceMXBean {
	...
	/**
	 * Returns the number of times {@link DataService#createReference
	 * createReference} has been called.
	 * 
	...
	/**
	 * Returns the number of times {@link DataService#getBinding getBinding} has
	 * been called.
	 * 
	...
	/**
	 * Returns the number of times {@link DataService#getBindingForUpdate
	 * getBindingForUpdate} has been called.
	 * 
	...
	/**
	 * Returns the number of times {@link DataService#getObjectId getObjectId}
	 * has been called.
	 * 
	...
	/**
	 * Returns the number of times {@link DataService#markForUpdate
	 * markForUpdate} has been called.
	 * 
	...
	/**
	 * Returns the number of times {@link DataService#nextBoundName
	 * nextBoundName} has been called.
	 * 
	...
	/**
	 * Returns the number of times {@link DataService#removeBinding
	 * removeBinding} has been called.
	 * 
	...
	/**
	 * Returns the number of times {@link DataService#removeObject removeObject}
	 * has been called.
	 * 
	...
	/**
	 * Returns the number of times {@link DataService#setBinding setBinding} has
	 * been called.
	 * 
	...
	/**
	 * Returns the number of times {@link DataService#createReferenceForId
	 * createReferenceForId} has been called.
	 * 
	...
	/**
	 * Returns the number of times {@link DataService#getServiceBinding
	 * getServiceBinding} has been called.
	 * 
	 ...
	 * {@link DataService#getServiceBindingForUpdate getServiceBindingForUpdate}
	 * has been called.
	 * 
	...
	/**
	 * Returns the number of times {@link DataService#nextObjectId nextObjectId}
	 * has been called.
	 * 
	...
	/**
	 * Returns the number of times {@link DataService#nextServiceBoundName
	 * nextServiceBoundName} has been called.
	 * 
	...
	/**
	 * Returns the number of times {@link DataService#removeServiceBinding
	 * removeServiceBinding} has been called.
	 * 
	...
	/**
	 * Returns the number of times {@link DataService#setServiceBinding
