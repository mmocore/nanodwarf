...
public interface AffinityGroupFinderMXBean {
	...
	/**
	 * Returns the number of groups found in the latest run of the affinity
	 * group finder.
	 * 
	...
	/**
	 * Returns the number of times the affinity group finder has run, including
	 * runs that fail.
	 * 
	...
	/**
	 * Returns the number of times the affinity group finder has failed, due to
	 * errors or node failures during a run.
	 * 
	...
	/**
	 * Returns the number of times the affinity group finder was stopped due to
	 * not converging soon enough. A stopped run is not a failed run; valid
	...
	/**
	 * Returns the configured maximum number of iterations allowed to run before
	 * stopping the algorithm and returning the current results.
	 * 
	...
	/**
	 * Returns the time of the last call to {@link #clear}, or the time this
	 * MBean was created if {@code clear} has never been called. The time is the
	 * difference, measured in milliseconds, between the time at which this was
	 * last cleared and midnight, January 1, 1970 UTC.
	 * 
	...
	/**
	 * Finds affinity groups based on the current graph information. This will
	 * start a new run of the affinity group finder, or wait for the current run
	 * to complete.
	 * <p>
