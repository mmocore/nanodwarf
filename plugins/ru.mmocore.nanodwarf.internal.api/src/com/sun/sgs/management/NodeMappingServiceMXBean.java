...
public interface NodeMappingServiceMXBean {
	 ...
	 * has been called.
	 * 
	 * @return the number of times {@code addNodeMappingListener} has been
	 *         called
	 */
	 ...
	 * 
	 * @return the number of times {@code addIdentityRelocationListener} has
	 *         been called
	 */
	long getAddIdentityRelocationListenerCalls();

	/**
	 * Returns the number of times {@link NodeMappingService#assignNode
	...
	/**
	 * Returns the number of times {@link NodeMappingService#getIdentities
	...
	/**
	 * Returns the number of times {@link NodeMappingService#getNode getNode}
	 * has been called.
	 * 
	...
	/**
	 * Returns the number of times {@link NodeMappingService#setStatus
