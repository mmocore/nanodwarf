...
public interface TaskAggregateMXBean {
	 ...
	 * A large average indicates the task queue is falling behind.
	 * 
	...
	/**
	 * Returns the average lag time for successful tasks, in milliseconds. Lag
	 * time is the amount of time spent on the ready queue before the task
	 * starts.
	 * 
	 ...
	 * Latency is total amount of time it takes a successful task to run, and is
	 * the sum of lagtime and runtime.
	 * 
	 ...
	 *             if the value is not between {@code 0.0} and {@code 1.0},
	 *             inclusive
	 */
