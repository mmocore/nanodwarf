...
public class NodeInfo implements Serializable {
	 ...
	 *            the node's health
	 * @param backup
	 *            the backup node for this node
	 * @param jmxPort
	 *            the port for JMX remote connections
	 */
	...
	/**
	 * Returns whether the node is alive or failed. Once a node has failed, it
	 * is never considered alive again and is removed from the system when any
	 * required fail-over procedures have completed.
	 * 
	...
	/**
	 * Returns the node id of the backup node for this node, or {@code -1} if no
	 * backup is assigned.
	 * 
	 * @return the node id of the backup node, or {@code -1} if no backup is
	 *         assigned.
	 */
