...
public interface TaskServiceMXBean {
	 ...
	 * 
	 * @return the number of times {@code scheduleNonDurableTask} has been
	 *         called
	 */
	...
	/**
	 * Returns the number of times {@link TaskService#scheduleTask(Task)
	 * scheduleTask} has been called.
	 * 
	...
	/**
	 * Returns the number of times {@link TaskService#scheduleTask(Task, long)
	 * scheduleTask} has been called with a delay.
	 * 
	 * @return the number of times {@code scheduleTask} has been called with a
	 *         delay.
	 */
