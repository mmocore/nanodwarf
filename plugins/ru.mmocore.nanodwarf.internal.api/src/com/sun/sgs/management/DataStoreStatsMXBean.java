...
public interface DataStoreStatsMXBean {
	...
	/**
	 * Returns the number of times {@link DataStore#createObject(Transaction)
	 * createObject} has been called.
	 * 
	 ...
	 * {@link DataStore#getBinding(Transaction, String) getBinding} has been
	 * called.
	 * 
	...
	/**
	 * Returns the number of times
	 * {@link DataStore#getClassId(Transaction, byte[]) getClassId} has been
	 * called.
	 * 
	...
	/**
	 * Returns the number of times
	 * {@link DataStore#getClassInfo(Transaction, int) getClassInfo} has been
	 * called.
	 * 
	...
	/**
	 * Returns the number of times
	 * {@link DataStore#getObject(Transaction, long, boolean) getObject} has
	 * been called with a {@code false} argument.
	 * 
	 ...
	 * Returns the number of times
	 * {@link DataStore#getObject(Transaction, long, boolean) getObject} has
	 * been called with a {@code true} argument.
	 * 
	 * @return the number of times {@code getObject} has been called
	 */
	...
	/**
	 * Returns the number of times
	 * {@link DataStore#markForUpdate(Transaction, long) markForUpdate} has been
	 * called.
	 * 
	...
	/**
	 * Returns the number of times
	 * {@link DataStore#nextBoundName(Transaction, String) nextBoundName} has
	 * been called.
	 * 
	...
	/**
	 * Returns the number of times
	 * {@link DataStore#nextObjectId(Transaction, long) nextObjectId} has been
	 * called.
	 * 
	...
	/**
	 * Returns the number of times
	 * {@link DataStore#removeBinding(Transaction, String) removeBinding} has
	 * been called.
	 * 
	...
	/**
	 * Returns the number of times
	 * {@link DataStore#removeObject(Transaction, long) removeObject} has been
	 * called.
	 * 
	...
	/**
	 * Returns the number of times
	 * {@link DataStore#setBinding(Transaction, String, long) setBinding} has
	 * been called.
	 * 
	...
	/**
	 * Returns the number of times
	 * {@link DataStore#setObject(Transaction, long, byte[]) setObject} has been
	 * called.
	 * 
	...
	/**
	 * Returns the number of times
	 * {@link DataStore#setObjects(Transaction, long[], byte[][]) setObjects}
	 * has been called.
	 * 
	...
	/**
	 * Returns the average read byte sample value, smoothed with the smoothing
	 * factor.
	 * 
