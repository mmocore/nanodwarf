...
/**
 * The interface for interacting with the database implementation. Environments
...
public interface DbEnvironment {
	 ...
	 * 
	 * @param timeout
	 *            the number of milliseconds the transaction should be allowed
	 *            to run
	 * @return the transaction
	 * @throws IllegalArgumentException
	 *             if timeout is less than {@code 1}
	 ...
	 *            to run
	 * @param fullIsolation
	 *            if {@code true}, requires the transaction to support full
	 *            serializable isolation, otherwise uses the default transaction
	 *            isolation level
	 * @return the transaction
	 * @throws IllegalArgumentException
	 *             if timeout is less than {@code 1}
	 ...
	 * was created, typically the {@code directory} argument passed to
	 * {@code DbEnvironmentFactory.getEnvironment}.
	 * 
	 * @param txn
	 *            the transaction under which the database should be opened
	 * @param fileName
	 ...
	 * @return the database
	 * @throws IllegalArgumentException
	 *             if {@code txn} was not created by this environment
	 * @throws FileNotFoundException
	 *             if {@code create} is {@code false} and the database is not
	 *             found
	 * @throws DbDatabaseException
	 *             if an unexpected database problem occurs
	 */
	 ...
	 * 
	 * @return whether object allocations should use an end-of-block placeholder
	 */
