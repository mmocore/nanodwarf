...
/**
 * The interface to a database. Databases are associated with a single database
 * environment, and must be closed before the environment is closed. Databases
 * must not be used after the {@link #close close} method is called.
 */
public interface DbDatabase {

	/**
	 * Gets the value associated with a key in this database. Returns
	 * {@code null} if the key is not found.
	 * 
	 * @param txn
	 *            the transaction for this operation
	 * @param key
	 *            the key
	 * @param forUpdate
	 *            whether the object should be locked for update
	 * @return the associated value, or {@code null} if the key was not found
	 * @throws IllegalArgumentException
	 *             if {@code txn} was not created by the associated environment
	 ...
	 * should not be used after this method is called. This method should not be
	 * called if the transactions associated with any operations performed on
	 * this database are still open. This method should be called before closing
