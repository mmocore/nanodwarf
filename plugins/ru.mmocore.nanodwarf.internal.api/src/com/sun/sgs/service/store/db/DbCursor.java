 ...
 * newly created cursor has no current key or value. Cursors are associated with
 * a single transaction, and must be created and closed within that single
...
public interface DbCursor {
	...
	/**
	 * Searches for the first key in the database. If the result is {@code true}
	 * , then sets the current key and value to the first key and its associated
	 * value.
	 * 
	 ...
	 * key, then searches for the first key. If the result is {@code true}, then
	 * sets the current key and value to the key found and its associated value.
	 * 
	...
	/**
	 * Searches for the first key that is greater than or equal to the specified
	 * key. If the result is {@code true}, then sets the current key and value
	 * to the key found and its associated value.
	 * 
	 * @param key
	 *            the key at which to start searching
	 * @return {@code true} if the next key was found, else {@code false}
	 * @throws TransactionAbortedException
	 *             if the transaction should be aborted due to timeout or
	 *             conflict
	...
	/**
	 * Searches for the last key in the database. If the result is {@code true},
	 * then sets the current key and value to the last key and its associated
	 * value.
	 * 
	 ...
	 * @param value
	 *            the value
	 * @return {@code true} if a value was stored for the key, and {@code false}
