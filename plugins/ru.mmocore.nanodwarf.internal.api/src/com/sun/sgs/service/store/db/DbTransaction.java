...
public interface DbTransaction {
	 ...
	 * be called if any cursors associated with this transaction are still open.
	 * No methods should be called on this transaction after this method is
	 * called.
	 * 
	 * @param gid
	 *            the global transaction ID, which must be at least 128 bytes
	...
	/**
	 * Commits the transaction. This method should not be called if any cursors
