...
/**
 * An abstraction for node information, used in conjunction with the
 * {@link WatchdogService} and {@link NodeListener}s.
 */
public interface Node {
	...
	/**
	 * Returns {@code true} if the node is known to be alive, and {@code false}
	 * if the node is thought to have failed or is unknown.
	 * 
