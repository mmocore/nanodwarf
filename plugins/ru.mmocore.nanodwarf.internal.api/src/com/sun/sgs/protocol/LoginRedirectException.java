...
/**
 * An exception that indicates a login should be redirected to the node returned
 * by this exception's {@link #getNodeId getNodeId} method.
 */
public class LoginRedirectException extends Exception {
	...
	/**
	 * Constructs an instance with the specified {@code nodeId} and protocol
	 * {@code descriptors}.
	 * 
	 * @param nodeId
	 *            a node ID
	 * @param descriptors
	 *            a collection of protocol descriptors supported by the
	 *            specified {@code node}, or {@code null}
	 */
	 ...
	 * {@code descriptors} and detail {@code message}.
	 * 
	 * @param nodeId
	 *            a node ID
	 * @param descriptors
	 ...
	 */
	public LoginRedirectException(long nodeId,
			Set<ProtocolDescriptor> descriptors, String message) {
	 ...
	 */
	public LoginRedirectException(long nodeId,
			Set<ProtocolDescriptor> descriptors, String message, Throwable cause) {
		super(message, cause);
		if (nodeId < 0) {
	...
	/**
	 * Returns a collection of protocol descriptors supported by the node whose
	 * ID is returned by {@link #getNodeId getNodeId}.
	 * 
