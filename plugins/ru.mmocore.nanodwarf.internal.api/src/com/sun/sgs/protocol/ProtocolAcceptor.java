...
public interface ProtocolAcceptor {
	...
	/**
	 * Returns the descriptor for this protocol. Multiple calls to this method
	...
	/**
	 * Starts accepting connections, and notifies the specified {@code listener}
	 * of new connections.
	 * 
	 * <p>
	 ...
	 * listener's {@link ProtocolListener#newLogin newLogin} method with the
	 * identity and the {@link SessionProtocol protocol connection}.
	 * 
	 * @param listener
	 *            a protocol listener
	 * @throws IOException
