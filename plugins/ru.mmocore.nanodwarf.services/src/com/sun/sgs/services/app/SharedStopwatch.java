 ...
 * methods are porovided, {@code stop} and {@code reset} to make it easier to
 * share the state of the {@code Stopwatch}.
 */
public class SharedStopwatch implements Stopwatch, ManagedObject, Serializable {
	 ...
	 * {@inheritDoc}
	 * <p>
	 * If this {@code SharedStopwatch} has been stopped then calling this method
	 * will re-start the watch.
	 */
	public void start() {
		if (totalTime != 0) {
			restart();
	 ...
	 * {@inheritDoc}
	 * <p>
	 * If this {@code SharedStopwatch} has been stopped then this will return
	 * the total time that this watch ran.
	 */
	 ...
	 * {@inheritDoc}
	 * <p>
	 * If this {@code SharedStopwatch} has been stopped then this will return 0.
	 */
	 ...
	 * observed, so the elapsed time reported will always be the time that the
	 * watch was running before being stopped. The watch is also split. If this
	 * watch has been stopped aleady then this call has no effect.
	 */
	public void stop() {
		if (totalTime != 0) {
			return;
	...
	/**
	 * Restarts a {@code SharedStopwatch} that may be either stopped or running.
	 */
	public void restart() {
		AppContext.getDataManager().markForUpdate(this);
		totalTime = 0;
