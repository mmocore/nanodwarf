 ...
 * application. A {@code Stopwatch}, once started, reports how much time has
 * passed as measured by the application clock. For convenience it can also
 * measure splits. There is no explicit way to stop a {@code Stopwatch}, so it
 * should just be discarded when no longer needed.
 * <p>
...
public interface Stopwatch {
	 ...
	 * {@code Stopwatch} was started. If this {@code Stopwatch} has not been
	 * started then this always returns 0.
	 * 
	 * @return the length in milliseconds that the {@code Stopwatch} has been
	 *         running
	 */
	long getElapsedTime();
	...
	/**
	 * Returns the total application time in milliseconds since the last split.
	 * If this {@code Stopwatch} has not been started then this always returns
	 * 0. If this {@code Stopwatch} has never been split then this returns the
	 * total elapsed time.
	 * 
