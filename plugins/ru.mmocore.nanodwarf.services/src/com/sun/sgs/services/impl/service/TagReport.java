...
public interface TagReport {
	...
	/**
	 * Returns the identifier for the transaction. Any tagged task is run in the
	 * context of a transaction, and all transaction identifiers are unique on a
	 * given node.
	 * 
	 ...
	 * {@code null} if no value was associated with the tag or if this tag
	 * identifier was not applied to the task.
	 * 
	 * @param tag
	 *            identifier of a tag
	 * 
