...
/**
 * An implementation of {@code TagReportListener} that periodically dumps all
 * reported data to an SQL container.
 */
public class SQLTagReportListener implements TagReportListener {
	...
	private static final String statementString = "INSERT INTO tags (node, txn, tag_id, tag_value) "
			+ "VALUES (?,?,?,?)";
	...
	public static final String COMMIT_SIZE_PROPERTY = SQLTagReportListener.class
			.getName() + ".commit.size";
	...
	private static void insertTagDetail(PreparedStatement stmt, TagReport report)
			throws SQLException {
