...
public class TransactionNotActiveException extends TransactionException
	 ...
	 * {@code shouldRetry} method will be called when deciding if this exception
	 * should be retried.
	 * 
	 * @param message
	 *            the detail message or <code>null</code>
	 ...
	 * {@code ExceptionRetryStatus}, then it will be called to determine if the
	 * exception should request to be retried. Otherwise, this will return
	 * {@code false}.
	 */
