 ...
 * when they are being removed from the {@link DataManager}. When the
 * {@link DataManager#removeObject DataManager.removeObject} method is called on
 * an object that implements this interface, that method will first call
 * {@link #removingObject removingObject} before removing the object from the
 * data manager. Managed objects containing references to other managed objects
 ...
 * been removed or is not currently managed by the data manager.
 * <p>
 * 
