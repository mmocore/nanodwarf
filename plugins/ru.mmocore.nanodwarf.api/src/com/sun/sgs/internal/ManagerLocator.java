 ...
 * application. Any implementation of the Project Darkstar API should provide a
 * single implementation of this interface that is to be used by the
 * {@link InternalContext} to locate managers in the system.
 * 
...
public interface ManagerLocator {
	 ...
	 *             if the {@code ChannelManager} cannot be located
	 */
	 ...
	 * @throws ManagerNotFoundException
	 *             if the {@code DataManager} cannot be located
	 */
	 ...
	 * @throws ManagerNotFoundException
	 *             if the {@code TaskManager} cannot be located
	 */
	 ...
	 * @throws ManagerNotFoundException
	 *             if no manager is found for the specified type
	 */
