 ...
 * <p>
 * Active connection initiation is accomplished by obtaining an {@code Endpoint}
 * 's {@link Connector} via {@link #createConnector}.
 * 
 * @param <T>
 *            the address family encapsulated by this {@code Endpoint}
 */
public interface Endpoint<T> {

	/**
	 * Creates a {@link Connector} for actively initiating a connection to this
	 ...
	 * 
	 * @throws IOException
	 *             if a connector cannot be created
	 */
