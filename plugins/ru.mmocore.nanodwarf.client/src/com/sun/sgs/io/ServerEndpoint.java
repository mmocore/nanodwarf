 ...
 * 
 * @param <T>
 *            the address family encapsulated by this {@code ServerEndpoint}
 */
public interface ServerEndpoint<T> {

	/**
	 * Creates an {@link Acceptor} to passively listen for connections on this
	 * local {@code ServerEndpoint}.
	 * 
