 ...
 * {@code SimpleClientConnector} each time {@code createConnector} is invoked.
 */
public class SimpleConnectorFactory implements ClientConnectorFactory {

	/**
	 * Creates a new instance of {@code SimpleClientConnector} based on the
	 * given {@code properties}.
	 * 
	 * @param properties
	 *            which affect the creation of the {@code SimpleClientConnector}
	 *            returned
