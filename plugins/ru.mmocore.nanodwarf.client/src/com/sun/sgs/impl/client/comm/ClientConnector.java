...
public abstract class ClientConnector {
	...
	private static ClientConnectorFactory theSingletonFactory = new com.sun.sgs.impl.client.simple.SimpleConnectorFactory();
	 ...
	 * 
	 * @param properties
	 *            which affect the implementation of {@code ClientConnector}
	 *            returned
	...
	/**
	 * Sets the {@link ClientConnectorFactory} that will be used to create new
	 * {@code ClientConnector}s.
	 * 
	 * @param factory
	 *            the factory to create new {@code ClientConnector}s
	 */
	...
	/**
	 * Actively initates a connection to the target remote address. This call is
	 * non-blocking. {@link ClientConnectionListener#connected} will be called
	 * asynchronously on the {@code listener} upon successful connection, or
	 * {@link ClientConnectionListener#disconnected} if it fails.
	 * 
	 * @param listener
	 ...
	 * 
	 * @throws IOException
	 *             if an IO error occurs synchronously
