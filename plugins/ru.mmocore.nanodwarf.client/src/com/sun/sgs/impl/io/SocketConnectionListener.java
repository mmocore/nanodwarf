...
/**
 * An adapter between an Apache {@link IoHandler MINA IoHandler} and the SGS IO
 * framework {@link ConnectionListener}. SocketHandlers exist one per
...
class SocketConnectionListener extends IoHandlerAdapter {
	...
	public void messageReceived(IoSession session, Object message)
		...
		try {
			...
			logger.logThrow(Level.FINER, e, "exception in recv of {0}:", buf);
			throw e;
		}
	}
}
