 ...
 */
public class SocketEndpoint extends AbstractSocketEndpoint implements
		Endpoint<SocketAddress> {
	/** The logger for this class. */
	private static final LoggerWrapper logger = new LoggerWrapper(
			Logger.getLogger(SocketEndpoint.class.getName()));

	/**
	 * Constructs a {@code SocketEndpoint} with the given {@link TransportType}.
	 * This is the simplest way to create a {@code SocketEndpoint}. The returned
	 * endpoint will use new daemon threads as necessary for processing events.
	 * 
	 * @param address
	...
	/**
	 * Constructs a {@code SocketEndpoint} with the given TransportType using
	 * the given {@link Executor} for thread management. The
	...
	public Connector<SocketAddress> createConnector() {
		...
		if (transportType.equals(TransportType.RELIABLE)) {
			minaConnector = new org.apache.mina.transport.socket.nio.NioSocketConnector(
					numProcessors);
		} else {
