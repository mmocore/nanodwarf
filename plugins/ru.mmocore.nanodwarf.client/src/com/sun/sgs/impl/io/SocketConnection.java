 ...
 * MINA framework. It uses a {@link IoSession MINA IoSession} to handle the IO
 * transport.
 */
public class SocketConnection implements Connection, FilterListener {
	 ...
	 * 
	 * @param listener
	 *            the {@code ConnectionListener} for the {@code Connection}
	 * @param filter
	 *            the {@code CompleteMessageFilter} for the {@code Connection}
	 * @param session
	 *            the {@code IoSession} for the {@code Connection}
	 */
	 ...
	 * 4-byte {@code int} in network byte-order, and sends it out on the
	 * underlying MINA {@code IoSession}.
	 * 
	 * @param message
	 *            the data to send
	 * @throws IOException
	 ...
	 * 
	 * @param buf
	 *            a {@code MINA ByteBuffer} containing the message to dispatch
	 */
	 ...
	 * 
	 * @param buf
	 *            the {@code MINA ByteBuffer} to send
	 */
