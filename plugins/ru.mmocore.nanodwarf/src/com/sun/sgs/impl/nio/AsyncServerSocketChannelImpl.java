...
/**
 * An implementation of {@link AsynchronousServerSocketChannel}. Most
 * interesting methods are delegated to the {@link AsyncKey} returned by this
 * channel's channel group.
 */
final class AsyncServerSocketChannelImpl extends
	 ...
	 */
	@Override
	public AsyncServerSocketChannelImpl bind(SocketAddress local, int backlog)
			throws IOException {
	...
	public <A> IoFuture<AsynchronousSocketChannel, A> accept(A attachment,
		...
		return key.execute(OP_ACCEPT, attachment, handler, 0,
