...
public class IoFutureTask<R, A> extends FutureTask<R> implements IoFuture<R, A> {
	...
	/**
	 * Creates an instance of this class for running the specified
	 * {@code Callable} and including the specified attachment.
	 * 
	 * @param callable
	 *            the callable task
	 * @param attachment
	 *            the attachment; may be {@code null}
	 */
	 ...
	 */
	public static <R, A> IoFuture newInstance(Callable<R> callable, A attachment) {
