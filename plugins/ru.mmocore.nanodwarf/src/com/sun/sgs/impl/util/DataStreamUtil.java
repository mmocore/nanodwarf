...
public final class DataStreamUtil {
	 ...
	 * {@code boolean} value {@code true} followed by the UTF for the string if
	 * it is not {@code null}, otherwise writes {@code false}.
	 * 
	 * @param string
	 *            the string or {@code null}
	 * @param out
	 *            the data output stream
	 * @throws IOException
	 *             if an I/O error occurs
