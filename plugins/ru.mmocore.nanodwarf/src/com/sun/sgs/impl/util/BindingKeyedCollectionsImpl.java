...
/**
 * An implementation of the collections factory. The kernel constructs this
 * factory during server initialization, and it is available to services via the
...
public class BindingKeyedCollectionsImpl implements BindingKeyedCollections {
	...
	/**
	 * Returns the data service relevant to the current context. This method is
	 * used by {@link BindingKeyedMapImpl} to obtain the data service to store
	 * key/value pairs.
	 * 
	 * @return the data service relevant to the current context
	 * @throws IllegalStateException
	 *             if an instance of this class has not been initialized
	 */
