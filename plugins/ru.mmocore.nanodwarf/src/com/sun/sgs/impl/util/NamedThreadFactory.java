...
public class NamedThreadFactory implements ThreadFactory {
	...
	/**
	 * Creates a new {@code NamedThreadFactory} that names each thread that it
	 * creates using the given {@code name}.
	 * 
	 * @param name
	 *            the prefix to use for each thread's name
	 */
	...
	/**
	 * Constructs a new {@code Thread} for the given {@code Runnable}. The name
	 * of the returned {@code Thread} is equal to the current count of the
