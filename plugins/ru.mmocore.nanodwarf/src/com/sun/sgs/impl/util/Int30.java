 ...
 * integers or values above 2^30 - 1 or {@value #MAX_VALUE}.
 * <p>
 * 
 ...
 * integer, with the following bytes holding the remaining bytes.
 * <p>
 * 
 * Values less than 2^6 are represented by just storing the value in a single
 * byte, since the top two marking bits are zero:
 * <p>
 * 
 * <ul>
 * <li>53 (0x35) => 0x35
 ...
 * the first byte set to 01 binary:
 * <p>
 * 
 * <ul>
 ...
 * less than 2^30 take four, with 11 binary in the top bits:
 * <p>
 * 
 * <ul>
...
public final class Int30 {
	...
	/*
	 * These fields represent the integer bits that are not allowed to be set in
	 * order to represent the integer in the specified number of bytes.
	 */
	 ...
	 *             if {@code n} is less than {@code 0} or greater than
	 *             {@value #MAX_VALUE}
	 * @throws IOException
