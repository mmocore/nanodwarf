 ...
 * {@code SchedulerRetryPolicy} always causes a task that throws a retryable
 * exception to retry immediately. This class supports the following
 ...
 * 
 * <dd style="padding-top: .5em">If a task has been retried a multiple of times
 * equal to the value of this property, then a {@code WARNING} message will be
 * logged as feedback to the user. This value must be greater than or equal to
 * {@code 1}.
 * 
 * </dl>
 * <p>
...
public class ImmediateRetryPolicy implements SchedulerRetryPolicy {
	...
	private static final LoggerWrapper logger = new LoggerWrapper(
			Logger.getLogger(ImmediateRetryPolicy.class.getName()));
	...
	public ImmediateRetryPolicy(Properties properties) {
		...
		this.retryWarningThreshold = wrappedProps.getIntProperty(
				...
				DEFAULT_RETRY_WARNING_THRESHOLD, 1, Integer.MAX_VALUE);
