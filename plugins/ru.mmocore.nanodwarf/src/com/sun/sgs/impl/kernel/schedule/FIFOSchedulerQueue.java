...
/**
 * This is a simple implemenation of <code>SchedulerQueue</code> that accepts
 * tasks and runs them in the order that they are ready. No attempt is made to
 * support priority, or to provide any degree of fairness between users. This
 * class uses an un-bounded queue. Unless the system runs out of memory, this
 * should always accept any tasks from any user.
 */
public class FIFOSchedulerQueue implements SchedulerQueue, TimedTaskListener {

	// logger for this class
	private static final LoggerWrapper logger = new LoggerWrapper(
			Logger.getLogger(FIFOSchedulerQueue.class.getName()));
