...
public abstract class AbstractAccessCoordinator implements AccessCoordinatorHandle
{
	 ...
	 * the overloadings of {@code reportObjectAccess} and
	 * {@code setObjectDescription} that supply default arguments. Subclasses
	 * should at least provide implementations of the four argument overloading
	 * of {@code reportObjectAccess} and the three argument overloading of
	 * {@code setObjectDescription}.
	 */
	public abstract class AbstractAccessReporter<T> implements AccessReporter<T>
	{
		...
		public void reportObjectAccess(T objId, AccessType type) {
			reportObjectAccess(txnProxy.getCurrentTransaction(), objId, type, null);
		}
		...
		/** {@inheritDoc} */
		public void reportObjectAccess(T objId, AccessType type, Object description) {
			reportObjectAccess(txnProxy.getCurrentTransaction(), objId, type, description);
		}

		/** {@inheritDoc} */
		public void setObjectDescription(T objId, Object description) {
			setObjectDescription(txnProxy.getCurrentTransaction(), objId, description);
		}
	}
}
