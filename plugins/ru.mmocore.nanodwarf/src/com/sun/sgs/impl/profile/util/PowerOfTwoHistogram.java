...
public class PowerOfTwoHistogram implements Histogram {
	 ...
	 * is incremented. Note that this histogram supports only
	 * <i>non-negative</i> values; negative values will not be counted.
	 */
	 ...
	 * The histogram is presented similar to the following example:
	 * 
	 * <pre>
	 *  8 |***
	 * 16 |
	 ...
	 * and trailing empty bins are truncated. The final line will have a newline
	 * at the end.
	 * 
