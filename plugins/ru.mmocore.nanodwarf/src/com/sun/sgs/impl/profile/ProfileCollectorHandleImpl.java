...
/**
 * The portion of a profile collector that allows the kernel to modify the state
 * of a particular collection record (initiates one, finishes one, that sort of
 * thing). Only particular classes are given access to instances of this class
 * by the kernel.
 */
