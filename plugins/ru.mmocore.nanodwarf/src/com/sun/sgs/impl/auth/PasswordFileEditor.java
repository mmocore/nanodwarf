...
/**
 * This is a simple utility program used to create the password files that are
 * consumed by <code>NamePasswordAuthenticator</code>. The password files
 * consist of one entry per line, where each entry has a name, some whitespace,
 * a SHA-256 hashed password encoded via a call to
...
public final class PasswordFileEditor {
	...
	/**
	 * Main-line for this utility. This utility takes three arguments on the
	 * command line. The first argument is the file to update, the second
	 * argument is the user name, and the third argument is that user's
	 * password.
	 * 
	 * @param args
	 *            the arguments for this utility
	 * 
	 * @throws Exception
	 *             if anything fails
	 */
	public static void main(String[] args) throws Exception {
		...
		byte[] pass = MessageDigest.getInstance("SHA-256").digest(
