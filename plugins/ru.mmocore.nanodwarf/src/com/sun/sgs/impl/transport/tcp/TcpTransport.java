...
/**
 * Implementation of a TCP {@link Transport}. The {@link #TcpTransport
 ...
 * Specifies the network port that the transport instance will listen on. The
 ...
 * 
 * <dd style="padding-top: .5em">
 * Specifies the acceptor backlog. This value is passed as the second argument
 * to the {@link AsynchronousServerSocketChannel#bind(SocketAddress,int)
...
public class TcpTransport implements Transport {
	...
	/**
	 * The server listen address property. This is the host interface we are
	 * listening on. Default is listen on all interfaces.
	 */
	...
	/**
	 * Closes the current acceptor and opens a new one, binding it to the listen
	 * address specified during construction. This method is invoked if a
	 * problem occurs handling a new connection or initiating another accept
	 * request on the current acceptor.
	 * 
	 * @throws IOException
	 *             if the async channel group is shutdown, or a problem occurs
	 *             creating the new acceptor or binding it to the listen address
	 */
