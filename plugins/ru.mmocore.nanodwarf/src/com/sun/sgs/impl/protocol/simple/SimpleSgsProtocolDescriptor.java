...
/**
 * A protocol descriptor with an underlying transport descriptor. A protocol may
 * use this class directly or extend it, overriding methods for protocol and/or
...
public class SimpleSgsProtocolDescriptor implements ProtocolDescriptor,
	 ...
	 * 
	 * <p>
	 * This implementation returns {@code true} if the specified
	 * {@code descriptor} is an instance of this class and this descriptor's
