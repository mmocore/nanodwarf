...
public class BasicState {
	...
	/**
	 * Disable this component. Multiple calls to disable are allowed. Disabled
	 * components can be enabled or shutdown.
	 * 
	...
	/**
	 * Enable this component. Multiple calls to enable are allowed. Enabled
	 * components can be disabled or shutdown.
	 * 
	 * @return {@code true} if the state has changed
	 */
	...
	/**
	 * Shutdown this component. Multiple shutdown calls are allowed. Once shut
	 * down, a component cannot be enabled or disabled.
	 * 
	 * @return {@code true} if the state has changed
	 */
	...
	/**
	 * Throws an IllegalStateException if we are in the {@code SHUTDOWN} state.
	 * 
	 ...
	 * 
	 * @throws IllegalStateException
	 *             if we are shut down or disabled
	 */
