 ...
 * <p>
 * These affinity groups can span multiple nodes and will eventually relocate
 * their members to a single node. There probably needs to be some external
 * control of the relocation in case we merge affinity groups or find that an
 * algorithm run returns a single group.
 */
public class RelocatingAffinityGroup implements AffinityGroup, Comparable {
	 ...
	 *            the group id
	 * @param identities
	 *            the identities and their nodes in the group
	 * @param generation
	 *            the generation number of this group
	 * @throws IllegalArgumentException
	 *             if {@code identities} is empty
	 */
	...
	public boolean equals(Object obj) {
		...
		return (agid == other.agid) && (generation == other.generation)
