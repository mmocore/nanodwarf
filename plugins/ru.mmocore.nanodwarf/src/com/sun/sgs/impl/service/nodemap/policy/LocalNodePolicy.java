 ...
 * node. Round robin assignment is used when the server is making the request
 * due to node failure.
 */
public class LocalNodePolicy extends RoundRobinPolicy {

	/**
	 * Creates a new instance of the LocalNodePolicy, which always assigns an
	 * identity to the node which requested an assignment be made.
	 * 
	 * @param props
	 *            service properties
	 */
	 ...
	 * {@inheritDoc}
	 * <p>
	 * This implementation simply assigns to the node making the request. Round
	 * robin assignment is used if the server is making the request (due to
	 * reassigning identities from a failed node).
	 */
