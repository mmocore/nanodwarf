...
public class DataStoreProfileProducer implements DataStore,
	...
	/**
	 * Creates an instance that delegates all {@link DataStore} and
	 * {@link TransactionParticipant} methods to {@code dataStore}.
	 * 
	 * @param dataStore
	 *            the object for delegating operations
	 * @param collector
	 *            the object for collecting profile data
	 * @throws IllegalArgumentException
	 *             if {@code dataStore} does not implement
	...
	public void markForUpdate(Transaction txn, long oid) {
		 ...
		 * increment the read objects and bytes counters here, but we don't have
		 * access to that information within the implementation. -tjb@sun.com
		 * (08/05/2008)
		 */
	}
	...
	public byte[] getObject(Transaction txn, long oid, boolean forUpdate) {
		...
		ProfileOperation op = forUpdate ? stats.getObjectForUpdateOp
				: stats.getObjectOp;
		op.report();
