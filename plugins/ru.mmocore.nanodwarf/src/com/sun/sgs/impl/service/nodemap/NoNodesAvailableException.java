...
/**
 * 
 * Thrown if the {@link NodeAssignPolicy} could not choose a node for assignment
 * because no nodes were available to it.
 * <p>
 * Note that this exception is very specific; perhaps we'll want a more general
 * exception to be thrown from {@link NodeAssignPolicy#chooseNode}.
 */
