 ...
 */
/*
 * XXX: Limit connections and/or close unused connections? XXX: Close and not
 * return sockets on IOException?
 */
class DataStoreClientRemote extends DataStoreProtocolClient {
	...
	DataStoreProtocol createHandler() throws IOException {
		...
		return new DataStoreProtocol(socket.getInputStream(),
