...
public class AbstractAffinityGraphBuilder extends BasicState {
	...
	public static final String PERIOD_COUNT_PROPERTY = PROP_BASE
			+ ".snapshot.count";
	 ...
	 * 
	 * @param properties
	 *            the configuration properties for this graph builder
	 */
	protected AbstractAffinityGraphBuilder(Properties properties) {
		wrappedProps = new PropertiesWrapper(properties);
		snapshot = wrappedProps
				.getLongProperty(PERIOD_PROPERTY, DEFAULT_PERIOD);
		periodCount = wrappedProps.getIntProperty(PERIOD_COUNT_PROPERTY,
				DEFAULT_PERIOD_COUNT, 1, Integer.MAX_VALUE);
