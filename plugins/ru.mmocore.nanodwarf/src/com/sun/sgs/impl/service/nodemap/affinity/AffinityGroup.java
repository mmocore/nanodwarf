...
/**
 * An affinity group in the system. Affinity groups are sets of identities that
 ...
 * groups which have the same affinity group identifier but different generation
 * numbers cannot be assumed to be related in any way.
 */
public interface AffinityGroup {
	...
	/**
	 * Returns a generation number for this affinity group. Affinity groups in
	 * the same generation were created at approximately the same time, so they
	 * can be used as the set of communities found at that time. Affinity groups
