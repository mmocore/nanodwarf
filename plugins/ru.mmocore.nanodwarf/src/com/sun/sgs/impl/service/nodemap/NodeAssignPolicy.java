...
public interface NodeAssignPolicy {
	 ...
	 *            the id of the node making the request, or {@code SERVER_NODE}
	 *            if the system is making the request
	 * 
	 * @return the chosen node's id
	 * 
	 * @throws NoNodesAvailableException
	 *             if there are no live nodes to assign to
	 */
	 ...
	 *            if the system is making the request
	 * @param id
	 *            the identity which needs an assignment.
	 * 
	 * @return the chosen node's id
	 * 
	 * @throws NoNodesAvailableException
