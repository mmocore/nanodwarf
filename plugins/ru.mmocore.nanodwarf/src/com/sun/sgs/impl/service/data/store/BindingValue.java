...
public final class BindingValue implements Serializable {
	...
	/**
	 * The value of the requested name, or {@code -1} if the name was not bound.
	 */
	 ...
	 * 
	 * @param oid
	 *            the value of the requested name or {@code -1}
	 * @param nextName
	 *            the next name or {@code null}
	 * @throws IllegalArgumentException
	 *             if {@code oid} is less than {@code -1}
	 */
	...
	/**
	 * Returns the object ID that the requested name was bound to, or {@code -1}
	 * if the name was not bound.
	 * 
	 ...
	 * returns {@code null}. The value will also be {@code null} if there was no
	 * bound name after the requested name.
	 * 
