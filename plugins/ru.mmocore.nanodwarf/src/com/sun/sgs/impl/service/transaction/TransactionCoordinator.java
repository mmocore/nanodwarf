...
public interface TransactionCoordinator {
	...
	String TXN_UNBOUNDED_TIMEOUT_PROPERTY = "com.sun.sgs.txn.timeout.unbounded";
	 ...
	 */
	String TXN_DISABLE_PREPAREANDCOMMIT_OPT_PROPERTY = "com.sun.sgs.txn.disable.prepareandcommit.optimization";

	/**
	 * Creates a new transaction, and returns a handle for managing it. If a
	 * timeout of {@link ScheduledTask#UNBOUNDED} is given, a transaction will
	 * be created with the timeout value specified by the property
	 * {@value #TXN_UNBOUNDED_TIMEOUT_PROPERTY}.
	 * 
	 * @param timeout
	 *            the timeout, in milliseconds, to be used for this transaction
	 * 
	 ...
	 * This value is specified using the property {@value #TXN_TIMEOUT_PROPERTY}
	 * 
