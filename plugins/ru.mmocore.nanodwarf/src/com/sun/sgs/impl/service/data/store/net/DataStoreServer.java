...
public interface DataStoreServer extends Remote {
	 ...
	 * not required to unassign any of the IDs so long as other operations treat
	 * them as non-existent objects.
	 * 
	 * @param tid
	 *            the ID of the transaction under which the operation should
	 *            take place
	 * @return the new object ID
	 * @throws IllegalArgumentException
	 *             if {@code tid} is negative
	 ...
	 *            the object ID
	 * @throws IllegalArgumentException
	 *             if {@code tid} or {@code oid} is negative
	 * @throws TransactionAbortedException
	 *             if the transaction was aborted due to a lock conflict or
	 *             timeout
	 * @throws TransactionNotActiveException
	 ...
	 *             if a network problem occurs
	 */
	byte[] getObject(long tid, long oid, boolean forUpdate) throws IOException;
	 ...
	 *            the data
	 * @throws IllegalArgumentException
	 *             if {@code tid} or {@code oid} is negative, or if {@code data}
	 *             is empty
	 * @throws TransactionAbortedException
	 *             if the transaction was aborted due to a lock conflict or
	 *             timeout
	 ...
	 * @throws IllegalArgumentException
	 *             if {@code tid} is negative, if {@code oids} and {@code data}
	 *             are not the same length, or if {@code oids} contains a value
	 *             that is negative
	 * @throws TransactionAbortedException
	 *             if the transaction was aborted due to a lock conflict or
	 *             timeout
	 ...
	 * value contains the object ID that the name is bound to and a next name of
	 * {@code null}. If the name is not bound, the return value contains an
	 * object ID of {@code -1} and the next name found, which may be
	 * {@code null}.
	 * 
	 * @param tid
	 *            the ID of the transaction under which the operation should
	 ...
	 * contains an arbitrary non-negative object ID and a next name of
	 * {@code null}. If the name is not bound, the return value contains an
	 * object ID of {@code -1} and the next name found, which may be
	 * {@code null}.
	 * 
	 ...
	 *             if a network problem occurs
	 */
	BindingValue setBinding(long tid, String name, long oid) throws IOException;
	 ...
	 * {@code -1}. In all cases, the return value contains the next name found,
	 ...
	 * @throws IllegalArgumentException
	 *             if {@code tid} is negative, or if {@code classId} is not
	 *             greater than {@code 0}
	 ...
	 * 
	 * @param timeout
	 *            the number of milliseconds the resulting transaction should be
	 *            allowed to run before it times out
	 * @return the ID of the new transaction
	 * @throws IllegalArgumentException
	 *             if the argument is less than or equal to {@code 0}
	 * @throws IOException
	 *             if a network problem occurs
	 */
	 ...
	 *             if {@code tid} is negative
	 * @throws IllegalStateException
	 *             if the transaction has been prepared, committed, or aborted,
	 *             or if the transaction is not known
	 * @throws IOException
	 *             if a network problem occurs
	 */
	 ...
	 *             if {@code tid} is negative
	 * @throws IllegalStateException
	 *             if the transaction has not been prepared, if it has been
	 ...
	 *             if {@code tid} is negative
	 * @throws IllegalStateException
	 *             if the transaction has been committed or aborted, or if the
