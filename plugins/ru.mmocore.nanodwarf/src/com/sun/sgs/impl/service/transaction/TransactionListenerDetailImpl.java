...
/**
 * Simple implementation of {@code TransactionListenerDetail} that is
 * package-private and used by {@code TransactionImpl} to report detail
...
class TransactionListenerDetailImpl implements TransactionListenerDetail {
	 ...
	 * 
	 * @param listenerName
	 *            the name of the listener associated with this detail
	 */
	...
	/**
	 * Sets that the listener's {@code afterCompletion} method was called and
