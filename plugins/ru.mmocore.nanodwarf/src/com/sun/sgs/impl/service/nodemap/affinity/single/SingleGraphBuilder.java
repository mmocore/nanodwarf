...
/**
 * A minimal graph builder for single node testing. This is mostly a copy of the
 * WeightedGraphBuilder, with the parts about node conflicts deleted.
 */
public class SingleGraphBuilder extends AbstractAffinityGraphBuilder implements
	 ...
	 * aid maintaining weighted edges). TBD: consider changing this to another
	 * data structure not using inner maps.
	 */
	 ...
	 * with a call to {@code setStats} or a {@code NullPointerException} will be
	 * thrown on the first call to {@code updateGraph}.
	 * 
	 * @param properties
	 *            the properties for configuring this builder
	 * @param systemRegistry
	 ...
	 *            the transaction proxy
	 * @param needStats
	 *            {@code true} if stats should be constructed
	 * @throws Exception
	 *             if an error occurs
	 */
	public SingleGraphBuilder(Properties properties,
			ComponentRegistry systemRegistry, TransactionProxy txnProxy,
			boolean needStats) throws Exception {
		super(properties);
	 ...
	 * 
	 * @param owner
	 *            the identity which accessed the objects
	 * @param objIds
	 *            the object ids of objects accessed by the identity
	 */
	...
	/**
	 * Sets the JMX MBean for this builder. This is useful for classes which
	 * wrap this object. Note that stats must be set before the first call to
	 * updateGraph, or a {@code NullPointerException} will occur.
	 * 
	 * @param stats
	 *            our JMX information
	 */
