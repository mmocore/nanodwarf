...
/**
 * A listener which detects object uses by Identities within tasks and builds a
...
public class GraphListener implements ProfileListener {
	 ...
	 * <p>
	 * NOTE: this constructor should never be used, but is provided to satisfy
	 * the {@code ProfileListener} documentation. This listener cannot be
	 * provided as as a property, it is created within the system for the
	 * server's use.
	 * 
	 * @param properties
	 *            the configuration properties
	 * @param owner
	 *            task owner for any tasks run by this listener
	 * @param registry
	 *            the system registry
	 */
	public GraphListener(Properties properties, Identity owner,
	 ...
	 * 
	 * @param builder
	 *            the affinity graph builder to report to
	 * 
