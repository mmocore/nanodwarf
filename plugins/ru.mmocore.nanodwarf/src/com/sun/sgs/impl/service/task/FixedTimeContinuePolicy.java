...
/**
 * An implementation of {@code ContinuePolicy} that always provides positive
 * continuation feedback until a fixed amount of time has elapsed in the current
 * transaction. After this time period has elapsed, feedback is always negative
 * for the given transaction. This time period is configurable via the following
 ...
 * start of a transaction during which the {@link #shouldContinue()
 * shouldContinue} method will return {@code true}. After this period of time
 * has elapsed in a transaction, this method will always return {@code false}.
 * 
 * </dl>
 * <p>
 */
public class FixedTimeContinuePolicy implements ContinuePolicy {
	...
	private static final LoggerWrapper logger = new LoggerWrapper(
			Logger.getLogger(FixedTimeContinuePolicy.class.getName()));
	 ...
	 */
	public static final String CONTINUE_THRESHOLD_PROPERTY = PKG_NAME
			+ ".continue.threshold";
	...
	public FixedTimeContinuePolicy(Properties properties,
		...
		logger.log(Level.CONFIG,
				"Created FixedTimeContinuePolicy with properties:" + "\n  "
						+ CONTINUE_THRESHOLD_PROPERTY + "=" + continueThreshold);
	}
	...
	public boolean shouldContinue() {
		...
		return System.currentTimeMillis() - txn.getCreationTime() < continueThreshold;
	}
