...
/**
 * Wrapper around a {@link Logger} that provides convenience methods for logging
 * exceptions and messages with multiple arguments, and that insulates the
 * caller from unchecked exceptions thrown during the act of logging.
 */
public class LoggerWrapper {
	 ...
	 * 
	 * @param level
	 *            the level at which to check if logging is enabled
	 ...
	 * @param message
	 *            the log message, which can be <code>null</code>
	 */
	 ...
	 * method names of the caller of this method, if they can be determined. Any
	 * exceptions or errors thrown by the underlying <code>log</code> call are
	 * swallowed.
	 * 
	 * @param level
	 *            the level at which to log
	 ...
	 *            the log message, which can be <code>null</code>
	 * @param param
	 *            the parameter value for the log message, which can be
	 *            <code>null</code>
	 */
	 ...
	 * of the wrapped <code>Logger</code>, passing a {@link LogRecord}
	 * constructed with the given <code>level</code> and <code>message</code>
	 * values. The given <code>params</code> values are set as the
	 * {@linkplain LogRecord#setParameters parameters} of the
	 * <code>LogRecord</code>. The {@linkplain LogRecord#getSourceClassName
	 * source class name} and {@linkplain LogRecord#getSourceMethodName source
	 * method name} of the <code>LogRecord</code> are set to the class and
	 * method names of the caller of this method, if they can be determined. Any
	 ...
	 *            the log message, which can be <code>null</code>
	 * @param params
	 *            the parameter values for the log message, which can be
	 *            <code>null</code>
	 */
	 ...
	 * with the <code>LogRecord</code>. The
	 * {@linkplain LogRecord#setSourceClassName source class name} and
	 * {@linkplain LogRecord#setSourceMethodName source method name} of the
	 * <code>LogRecord</code> are set to the class and method names of the
	 * caller of this method, if they can be determined. Any exceptions or
	 * errors thrown by the underlying <code>log</code> call are swallowed.
	 * 
	 ...
	 *            the level at which to log
	 * @param thrown
	 *            the <code>Throwable</code> associated with the log message
	 * @param message
	 *            the log message, which can be <code>null</code>
	 */
	 ...
	 * values. The <code>thrown</code> value is set as the
	 * <code>Throwable</code> value {@linkplain LogRecord#setThrown associated}
	 * with the <code>LogRecord</code>. The given <code>params</code> values are
	 * set as the {@linkplain LogRecord#setParameters parameters} of the
	 * <code>LogRecord</code>. The {@linkplain LogRecord#setSourceClassName
	 * source class name} and {@linkplain LogRecord#setSourceMethodName source
	 * method name} of the <code>LogRecord</code> are set to the class and
	 * method names of the caller of this method, if they can be determined. Any
	 ...
	 * with the {@link #logThrow(Level, Throwable, String) logThrow} method. If
	 * the caller intends to include a <code>Throwable</code> as a parameter
	 * value in the log method, rather than including its stack trace by calling
	 * <code>logThrow</code>, it can cast the parameter to type
	 ...
	 * of the wrapped <code>Logger</code>, passing a {@link LogRecord}
	 * constructed with the given <code>level</code> and <code>message</code>
	 * values. The given <code>param</code> and <code>otherParams</code> values
	 ...
	 * by calling <code>logThrow</code>, it can cast the first parameter to type
	 * <code>Object</code> to avoid the deprecation warning.
	 * 
	 * @param level
	 *            the level at which to log
	 ...
	 *            <code>null</code>
	 * @param otherParams
	 *            additional parameter values for the log message, which can be
	 *            <code>null</code>
	 */
	@Deprecated
	public void log(Level level, String message, Throwable param,
	...
	/**
	 * Logs the given LogRecord to the wrapped Logger, after setting its source
	 * class and method names to those of the caller of this class (if the
	 * caller can be inferred). Swallows any exceptions or errors that result.
	 */
