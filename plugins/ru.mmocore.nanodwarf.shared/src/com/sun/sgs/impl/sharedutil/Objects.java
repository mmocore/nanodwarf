...
public final class Objects {
	 ...
	 */
	private static final ThreadLocal<Boolean> callingSafeToString = new ThreadLocal<Boolean>();
	 ...
	 * <p>
	 * 
	 * Returns {@code "null"} if the argument is {@code null}, otherwise returns
	 * the concatenation of the fully qualified name of the object's class, the
	 * {@code '#'} character, and the identity hash code of the object as
	 * returned by {@link System#identityHashCode System.identityHashCode},
	 ...
	 * the annotation needs to be applied to a declaration. It is more succinct
	...
	/**
	 * Checks that a variable is not {@code null}, throwing
	 * {@link NullPointerException} if it is. The exception message includes the
	...
	public static void checkNull(String variableName, Object value) {
		if (value == null) {
			throw new NullPointerException("The value of " + variableName
					+ " must not be null");
		}
	}
}
