 ...
 * Specifies the format string that will be used in a call to
 * {@link Formatter#format Formatter.format} to display the date and time of a
 * logging call. The argument to the format call will be a {@code long}
 * representing the current time in milliseconds. The default prints the time in
 * the format {@code 2008-02-14 11:52:59.679}.
 * <p>
 * 
 ...
 * 
 * <dd style="padding-top: .5em">
 * Specifies whether to print stack traces when formatting a log record that
...
public class LogFormatter extends java.util.logging.Formatter {
	...
	public String format(LogRecord record) {
		...
		formatter.format("%n%s: %s%n", record.getLevel().getLocalizedName(),
