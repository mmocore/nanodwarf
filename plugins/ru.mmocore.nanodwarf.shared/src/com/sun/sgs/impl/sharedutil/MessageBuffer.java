...
public class MessageBuffer {
	...
	/**
	 * Returns the size of the specified string, encoded in modified UTF-8
	 * format.
	 * 
	 * @param str
	 *            a string
	 * @return the size of the specified string, encoded in modified UTF-8
	 *         format
	 */
	...
	/**
	 * Constructs a message buffer using the specified byte array as the byte
	 * array that backs this buffer. Intializes this buffer's capacity and limit
	 * to the length of the specified byte array.
	 * 
	 * @param buf
	 *            the byte array to back this buffer
	 */
	...
	/**
	 * Puts the specified byte in this buffer's current position, and advances
	 * the buffer's position and limit by one.
	 * 
	 * @param b
	 *            a byte
	 * @return this buffer
	...
	/**
	 * Puts the specified char as a two-byte value (high byte first) starting in
	 * the buffer's current position, and advances the buffer's position and
	 * limit by two.
	 * 
	 * @param v
	 *            a char value
	...
	/**
	 * Puts the specified string, encoded in modified UTF-8 format, in the
	 * buffer starting in the buffer's the current position, and advances the
	 * buffer's position and limit by the size of the encoded string.
	 * 
	 * @param str
	 *            a string
	 * @return this buffer
	 * @throws IndexOutOfBoundsException
	 *             if adding the encoded string to this buffer would overflow
	 *             the buffer
	 */
	 ...
	 * @throws IndexOutOfBoundsException
	 *             if this buffer's limit would be reached as a result of
	 ...
	 * @throws IndexOutOfBoundsException
	 *             if this buffer's limit would be reached as a result of
	 *             getting the specified number of bytes
	 */
	...
	/**
	 * Returns a string that has been encoded in modified UTF-8 format, starting
