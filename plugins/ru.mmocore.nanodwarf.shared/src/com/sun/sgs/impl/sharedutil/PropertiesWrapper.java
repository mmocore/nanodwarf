...
public class PropertiesWrapper {
	 ...
	 * 
	 * @param properties
	 *            the <code>Properties</code> to wrap
	 */
	 ...
	 *             if the value does not contain a parsable <code>int</code>
	 */
	 ...
	 * @return the value
	 * @throws IllegalArgumentException
	 *             if the value or {@code defaultValue} is less than {@code min}
	 *             or greater than {@code max}, or if {@code min} is greater
	 *             than {@code max}
	 * @throws NumberFormatException
	 *             if the value does not contain a parsable <code>int</code>
	 */
	...
	/**
	 * Returns the value of a required {@code int} property within a bound range
	 * of values.
	 * 
	 * @param name
	 *            the property name
	 ...
	 *             if the value or {@code defaultValue} is less than {@code min}
	 *             or greater than {@code max}, or if {@code min} is greater
	 *             than {@code max}, or if the value is not set
	 * @throws NumberFormatException
	 *             if the value does not contain a parsable <code>int</code>
	 */
	 ...
	 * @return the value
	 * @throws NumberFormatException
	 *             if the value does not contain a parsable <code>long</code>
	 */
	 ...
	 * parameters. The class should extend or implement the specified type, and
	 * not be abstract.
	 * 
	 * @param <T>
	 ...
	 *            the property name
	 * @param type
	 *            the class which the return value should be an instance of
	 * @param paramTypes
	 ...
	 *         found
	 * @throws IllegalArgumentException
	 *             if the property is found and a problem occurs creating the
	 ...
	 *            the property name
	 * @param defaultClass
	 *            the fully qualified class name to use if the {@code name}
	 ...
	 * @throws IllegalArgumentException
	 *             if a problem occurs creating the instance, or if the
	 *             constructor throws a checked exception
	 */
	@SuppressWarnings("unchecked")
	public <T> T getClassInstanceProperty(String name, String defaultClass,
			Class<T> type, Class<?>[] paramTypes, Object... args) {
	 ...
	 * specified parameters. The class should extend or implement the specified
	 * type, and not be abstract.
	 * 
	 * @param <T>
	 *            the type of the return value
	 * @param name
	 *            the property name (used for exception message text), or
	 *            {@code null}
	 * @param className
	 *            the class name
	 * @param type
	 ...
	 *             constructor throws a checked exception
	 */
	private <T> T getClassInstance(String name, String className,
			Class<T> type, Class<?>[] paramTypes, Object... args) {
		if (className == null) {
		...
		try {
			return Class.forName(className).asSubclass(type)
					.getConstructor(paramTypes).newInstance(args);
		} catch (ClassNotFoundException e) {
			throw new IllegalArgumentException("The class " + className
					+ getPropertyText(name) + " was not found", e);
		} catch (ClassCastException e) {
			throw new IllegalArgumentException("The class " + className
					+ getPropertyText(name) + " does not implement "
					+ type.getName(), e);
			...
			throw new IllegalArgumentException("The class " + className
					...
					+ " does not have a constructor with required parameters: "
					+ sb, e);
			...
			if (cause instanceof RuntimeException) {
				...
				throw new IllegalArgumentException(
						"Calling the constructor for the class " + className
								+ getPropertyText(name) + " throws: " + cause,
						cause);
			}
		} catch (Exception e) {
			throw new IllegalArgumentException(
					"Creating an instance of the class " + className
							+ getPropertyText(name) + " throws: " + e, e);
		}
	}

	/**
	 * Returns a formatted string containing the property {@code name} (if it is
	 * non-null}, otherwise returns an empty string.
	 * 
	 * @param name
	 *            a property name or {@code null}
	 * @return if {@code name} is non-null, a formatted string containing the
	 *         property name; otherwise, an empty string
	 */
	 ...
	 * @return the value
	 * @throws IllegalArgumentException
	 *             if the value does not name a constant of the enumeration type
	 */
	public <T extends Enum<T>> T getEnumProperty(String name,
		...
		try {
			...
			throw new IllegalArgumentException("The value of the " + name
					+ " property was \"" + value + "\", but must be one of: "
	 ...
	 * single {@code String} parameter. If any of the {@code String}s in the
	 * colon separated list is an empty string, the value of
	 * {@code defaultElement} will be used for that item in the returned
	 * {@code List}. If the property with the given {@code name} is not found,
	 * an empty list will be returned.
	 * 
	 * @param <T>
	 *            the type of the objects in the returned {@code List}
	 * @param name
	 *            the property name
	 * @param type
	 *            the class which each object in the returned {@code List}
	 *            should be an instance of
	 * @param defaultElement
	 *            the default value to use if an empty {@code String} is one of
	 ...
	 *         found
	 * @throws IllegalArgumentException
	 *             if a problem occurs creating an instance of the given class
	 *             type, or the class type does not have a constructor that
	 *             takes a single {@code String} parameter
	 */
	...
	/**
	 * Returns a list of {@code Enum}s of the type specified by {@code enumType}
	 * . The objects are created from the property with the given {@code name}
	 * from the backing set of properties. The property is assumed to be a colon
	 * separated list of {@code String}s, and each element in the list is
	 * instantiated by calling the
	 * {@link Enum#valueOf(java.lang.Class, java.lang.String) Enum.valueOf}
	 * method on each respective {@code String} in the list. If any of the
	 * {@code String}s in the colon separated list is an empty string, the value
	 * of {@code defaultElement} will be used for that item in the returned
	 * {@code List}. If the property with the given {@code name} is not found,
	 * an empty list will be returned.
	 * 
	 * @param <T>
	 *            the {@code Enum} type of the objects in the returned
	 *            {@code List}
	 * @param name
	 *            the property name
	 * @param enumType
	 *            the {@code Enum} class which each object in the returned
	 ...
	 * @throws IllegalArgumentException
	 *             if any of the items in the list is not a valid value for the
	 *             given {@code Enum} type
	 */
	public <T extends Enum<T>> List<T> getEnumListProperty(String name,
			Class<T> enumType, T defaultElement) {
		Objects.checkNull("name", name);
		Objects.checkNull("enumType", enumType);
	...
	/**
	 * Returns a {@code List} of {@link Class} typed objects. The objects in the
	 * list are created from the property with the given {@code name} from the
	 * backing set of properties. The property is assumed to be a colon
	 * separated list of Strings, where each String is a fully qualified class
	 * name of a class. Any empty String appearing in the list will be added to
	 * the returned list as a {@code null}. If the property with the given
	 * {@code name} is not found, an empty list will be returned.
	 * 
	 * @param name
	 ...
	 *         the given name
	 * @throws IllegalArgumentException
	 *             if a {@code Class} cannot be found for any of the items in
	 *             the list
	 */
	public List<Class<?>> getClassListProperty(String name) {
		...
		for (String v : values) {
			...
			try {
				...
				throw new IllegalArgumentException(
						"A value in the list of items in the "
								+ name
								+ " property was \""
								+ v
								+ "\", but a class was not found for this value",
						cnfe);
			}
		}
