...
public class TestKernelCustomServices {
	...
	private static List<String> availableAuthenticators = new ArrayList<String>();
	/** List of profile listeners that have been created. */
	private static List<String> availableProfileListeners = new ArrayList<String>();
	...
	private Properties getSingleNodeProperties() throws Exception {
		return SgsTestNode.getDefaultProperties("TestKernelCustomServices",
				null, null);
	}
	...
	private void setServiceProperties(Properties props, String services,
			String managers, String nodeTypes) {
		if (services != null)
	...
	private void setExtServiceProperties(Properties props, String services,
			String managers, String nodeTypes) {
		if (services != null)
	...
	public void invalidService() throws Exception {
		Properties props = getSingleNodeProperties();
		setServiceProperties(props, InvalidService.class.getName(),
				InvalidManager.class.getName(), ServiceNodeTypes.ALL.toString());
		startCoreNode(props);
	}
	...
	public void serviceOnCoreNodeWithCoreNodeType() throws Exception {
		...
		setServiceProperties(props, Service1.class.getName(),
				Manager1.class.getName(), ServiceNodeTypes.CORE.toString());
		startCoreNode(props);
	...
	public void serviceOnCoreNodeWithAppNodeType() throws Exception {
		Properties props = getCoreNodeProperties();
		setServiceProperties(props, Service1.class.getName(),
				Manager1.class.getName(), ServiceNodeTypes.APP.toString());
		startCoreNode(props);
		Assert.assertTrue(runningServices.isEmpty());
		Assert.assertTrue(runningManagers.isEmpty());
	}
	...
	public void serviceOnCoreNodeWithSingleNodeType() throws Exception {
		Properties props = getCoreNodeProperties();
		setServiceProperties(props, Service1.class.getName(),
				Manager1.class.getName(), ServiceNodeTypes.SINGLE.toString());
		startCoreNode(props);
		Assert.assertTrue(runningServices.isEmpty());
		Assert.assertTrue(runningManagers.isEmpty());
	}
	...
	public void serviceOnCoreNodeWithAllNodeType() throws Exception {
		Properties props = getCoreNodeProperties();
		setServiceProperties(props, Service1.class.getName(),
				Manager1.class.getName(), ServiceNodeTypes.ALL.toString());
		startCoreNode(props);
		Assert.assertTrue(runningServices.contains(Service1.class.getName()));
		Assert.assertTrue(runningManagers.contains(Manager1.class.getName()));
	}
	...
	public void singleServiceNoManager() throws Exception {
		Properties props = getSingleNodeProperties();
		setServiceProperties(props, Service1.class.getName(), null,
	...
	public void multiServicesNoManager() throws Exception {
		...
		setServiceProperties(
				props,
				Service1.class.getName() + ":" + Service2.class.getName(),
				null,
				ServiceNodeTypes.ALL.toString() + ":"
						+ ServiceNodeTypes.ALL.toString());
		startCoreNode(props);
	...
	public void multiServicesAllManagers() throws Exception {
		Properties props = getSingleNodeProperties();
		setServiceProperties(props, Service1.class.getName() + ":"
				+ Service2.class.getName(), Manager1.class.getName() + ":"
				+ Manager2.class.getName(), ServiceNodeTypes.ALL.toString()
				+ ":" + ServiceNodeTypes.ALL.toString());
		startCoreNode(props);
		Assert.assertTrue(runningServices.contains(Service1.class.getName()));
		Assert.assertTrue(runningServices.contains(Service2.class.getName()));
	...
	public void multiServicesDifferentNodeTypes() throws Exception {
		...
		setServiceProperties(props, Service1.class.getName() + ":"
				...
				Manager1.class.getName() + ":" + Manager2.class.getName() + ":"
	...
	public void singleExtService() throws Exception {
		Properties props = getSingleNodeProperties();
		setExtServiceProperties(props, Service1.class.getName(),
				Manager1.class.getName(), ServiceNodeTypes.ALL.toString());
		startCoreNode(props);
		Assert.assertTrue(runningServices.contains(Service1.class.getName()));
		Assert.assertTrue(runningManagers.contains(Manager1.class.getName()));
	...
	public void singleExtServiceNoManager() throws Exception {
		Properties props = getSingleNodeProperties();
		setExtServiceProperties(props, Service1.class.getName(), null,
				ServiceNodeTypes.ALL.toString());
		startCoreNode(props);
		Assert.assertTrue(runningServices.contains(Service1.class.getName()));
		Assert.assertTrue(runningManagers.isEmpty());
	...
	public void combinedSingleService() throws Exception {
		...
		setServiceProperties(props, Service1.class.getName(),
				Manager1.class.getName(), ServiceNodeTypes.ALL.toString());
		setExtServiceProperties(props, Service2.class.getName(),
				Manager2.class.getName(), ServiceNodeTypes.ALL.toString());
		startCoreNode(props);
		Assert.assertTrue(runningServices.contains(Service1.class.getName()));
		Assert.assertTrue(runningServices.contains(Service2.class.getName()));
	...
	public void combinedMultiServices() throws Exception {
		...
		setServiceProperties(props, Service1.class.getName() + ":"
				+ Service2.class.getName(), Manager1.class.getName() + ":"
				+ Manager2.class.getName(), null);
		setExtServiceProperties(props, Service3.class.getName() + ":"
				+ Service4.class.getName(), Manager3.class.getName() + ":"
				+ Manager4.class.getName(), null);
		startCoreNode(props);
		Assert.assertTrue(runningServices.contains(Service1.class.getName()));
		Assert.assertTrue(runningServices.contains(Service2.class.getName()));
		Assert.assertTrue(runningServices.contains(Service3.class.getName()));
	...
	public void combinedMultiServicesSingleAndMultiManagers() throws Exception {
		...
		setServiceProperties(props, Service1.class.getName() + ":"
				+ Service2.class.getName(), Manager1.class.getName() + ":"
				+ Manager2.class.getName(), null);
		setExtServiceProperties(props, Service3.class.getName(), null, null);
		startCoreNode(props);
		Assert.assertTrue(runningServices.contains(Service1.class.getName()));
		Assert.assertTrue(runningServices.contains(Service2.class.getName()));
		Assert.assertTrue(runningServices.contains(Service3.class.getName()));
	...
	public void testExtServicesStartBeforeServices() throws Exception {
		Properties props = getSingleNodeProperties();
		setServiceProperties(props, DependentService.class.getName(), null,
				null);
		setExtServiceProperties(props, Service1.class.getName() + ":"
				+ Service2.class.getName(), Manager1.class.getName() + ":",
				null);
		...
		Assert.assertTrue(runningServices.contains(Service1.class.getName()));
		Assert.assertTrue(runningServices.contains(Service2.class.getName()));
		Assert.assertTrue(runningServices.contains(DependentService.class
				.getName()));
		Assert.assertTrue(runningManagers.contains(Manager1.class.getName()));
	}
	...
	public void singleAuthenticator() throws Exception {
		...
		startCoreNode(props);
		Assert.assertTrue(availableAuthenticators.contains(Authenticator1.class
				.getName()));
	}
	...
	public void multiAuthenticators() throws Exception {
		...
		Assert.assertTrue(availableAuthenticators.contains(Authenticator1.class
				.getName()));
		Assert.assertTrue(availableAuthenticators.contains(Authenticator2.class
				.getName()));
	}
	...
	public void combinedSingleAuthenticators() throws Exception {
		...
		Assert.assertTrue(availableAuthenticators.contains(Authenticator2.class
				.getName()));
		Assert.assertTrue(availableAuthenticators.indexOf(Authenticator2.class
				.getName()) < availableAuthenticators
				.indexOf(Authenticator1.class.getName()));
	}
	...
	public void combinedMultiAuthenticators() throws Exception {
		...
		Assert.assertTrue(availableAuthenticators.contains(Authenticator2.class
				.getName()));
		Assert.assertTrue(availableAuthenticators.contains(Authenticator3.class
				.getName()));
		Assert.assertTrue(availableAuthenticators.indexOf(Authenticator3.class
				.getName()) < availableAuthenticators
				.indexOf(Authenticator1.class.getName()));
		Assert.assertTrue(availableAuthenticators.indexOf(Authenticator1.class
				.getName()) < availableAuthenticators
				.indexOf(Authenticator2.class.getName()));
	}
	...
	public void singleProfileListener() throws Exception {
		...
		startCoreNode(props);
		Assert.assertTrue(availableProfileListeners
				.contains(ProfileListener1.class.getName()));
	}
	...
	public void multiProfileListeners() throws Exception {
		...
		Assert.assertTrue(availableProfileListeners
				.contains(ProfileListener1.class.getName()));
		Assert.assertTrue(availableProfileListeners
				.contains(ProfileListener2.class.getName()));
	}
	...
	public void combinedSingleProfileListeners() throws Exception {
		...
		Assert.assertTrue(availableProfileListeners
				.contains(ProfileListener2.class.getName()));
		Assert.assertTrue(availableProfileListeners
				.indexOf(ProfileListener2.class.getName()) < availableProfileListeners
				.indexOf(ProfileListener1.class.getName()));
	}
	...
	public void combinedMultiProfileListeners() throws Exception {
		...
		Assert.assertTrue(availableProfileListeners
				.contains(ProfileListener2.class.getName()));
		Assert.assertTrue(availableProfileListeners
				.contains(ProfileListener3.class.getName()));
		Assert.assertTrue(availableProfileListeners
				.indexOf(ProfileListener3.class.getName()) < availableProfileListeners
				.indexOf(ProfileListener1.class.getName()));
		Assert.assertTrue(availableProfileListeners
				.indexOf(ProfileListener1.class.getName()) < availableProfileListeners
				.indexOf(ProfileListener2.class.getName()));
	}
	...
	public static class Service1 extends TestAbstractService {
		public Service1(Properties p, ComponentRegistry c, TransactionProxy t) {
	...
	public static class Service2 extends TestAbstractService {
		public Service2(Properties p, ComponentRegistry c, TransactionProxy t) {
	...
	public static class Service3 extends TestAbstractService {
		public Service3(Properties p, ComponentRegistry c, TransactionProxy t) {
	...
	public static class Service4 extends TestAbstractService {
		public Service4(Properties p, ComponentRegistry c, TransactionProxy t) {
	...
	public static class DependentService extends TestAbstractService {
		public DependentService(Properties p, ComponentRegistry c,
				TransactionProxy t) {
	...
	public static abstract class AbstractAuthenticator implements
	...
	public static abstract class AbstractProfileListener implements
			ProfileListener {

		public AbstractProfileListener(Properties p, Identity i,
				ComponentRegistry c) {
