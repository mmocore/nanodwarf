...
/**
 * Tests for the various <code>SchedulerQueue</code> implementations. Note that
 * this is a general collection of tests that apply to any queue.
 */
...
public class TestSchedulerQueueImpl {
	...
	@Test
	public void constructorWithValidArgs() throws Exception {
		getQueueInstance();
	}
	...
	@Test
	public void addTaskDelayed() throws Exception {
		SchedulerQueue queue = getQueueInstance();
	...
	@Test
	public void addTasksDelayed() throws Exception {
		SchedulerQueue queue = getQueueInstance();
		ScheduledTask delayedTask = new ScheduledTaskImpl(testTask, 100);
	...
	@Test
	public void addTaskRecurring() throws Exception {
		getRecurringTask();
	}

	@Test
	public void addTasksRecurring() throws Exception {
		getRecurringTask();
		getRecurringTask();
		getRecurringTask();
		getRecurringTask();
	...
	public void cancelAfterStartRecurringTask() throws Exception {
		RecurringTaskHandle handle = getRecurringTask()
	...
	@Test
	public void addAndConsumeTask() throws Exception {
		SchedulerQueue queue = getQueueInstance();
	...
	public void reserveAndConsumeTasks() throws Exception {
		SchedulerQueue queue = getQueueInstance();
		TaskReservation reservation = queue
				.reserveTask(new ScheduledTaskImpl());
		reservation.use();
	...
	@Test
	public void addAndConsumeTaskDelayed() throws Exception {
		SchedulerQueue queue = getQueueInstance();
	...
	public void addAndConsumeTasksRecurring() throws Exception {
		RecurringTaskHandle handle1 = getRecurringTask()
				.getRecurringTaskHandle();
		handle1.start();
		RecurringTaskHandle handle2 = getRecurringTask()
				.getRecurringTaskHandle();
		handle2.cancel();
		RecurringTaskHandle handle3 = getRecurringTask()
				.getRecurringTaskHandle();
		handle3.start();
		handle1.cancel();
		handle3.cancel();
	...
	protected SchedulerQueue getQueueInstance(Properties p) throws Exception {
		...
		schedulerConstructor = schedulerClass.getConstructor(Properties.class);
	...
	private static class ScheduledTaskImpl implements ScheduledTask {
		...
		public Priority getPriority() {
			return Priority.getDefaultPriority();
		}
