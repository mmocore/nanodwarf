...
/**
 * Test for the {@code NowOrLaterRetryPolicy} class when it is plugged in to the
 * {@code TransactionScheduler}.
 */
...
public class TestNowOrLaterRetryPolicyIntegration {
	...
	public void startup() throws Exception {
		Properties properties = SgsTestNode.getDefaultProperties(
				"TestNowOrLaterRetryPolicyIntegration", null, null);
		...
		properties.setProperty(
				NowOrLaterRetryPolicy.RETRY_BACKOFF_THRESHOLD_PROPERTY, "5");
		serverNode = new SgsTestNode("TestNowOrLaterRetryPolicyIntegration",
				null, properties);
		txnScheduler = (TransactionScheduler) serverNode.getSystemRegistry()
