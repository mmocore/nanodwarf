...
public class TestScalableDeque extends Assert {
	 ...
	 */
	@Test
	public void testRemoveScalableDeque() throws Exception {
		...
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() {
				...
				ScalableDeque<Integer> d = uncheckedCast(dm.getBinding(name));
				dm.removeObject(d);
			}
		}, taskOwner);
	...
	public void testCopyConstructor() throws Exception {
		...
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				...
				ScalableDeque<Integer> test = new ScalableDeque<Integer>(
						control);
	...
	@Test
	public void testRemoveAllOccurrencesWhenOccurrenceNotPresent()
			throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
	...
	@Test
	public void testRemoveAllWithMultipleOccurrences() throws Exception {
	...
	@Test
	public void testRemoveAllWithMultipleRemoves() throws Exception {
	...
	@Test
	public void testDequeSerializable() throws Exception {
		...
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				...
				ScalableDeque<Integer> d = uncheckedCast(AppContext
	...
	@Test
	public void testIteratorSerializable() throws Exception {
		...
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				...
				for (int i = 0; i < 10; ++i)
					d.add(i);
				ManagedSerializable<Iterator<Integer>> iter = new ManagedSerializable<Iterator<Integer>>(
						d.iterator());
		...
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ManagedSerializable<Iterator<Integer>> iter = uncheckedCast(AppContext
						.getDataManager().getBinding(name));
	...
	@Test
	public void testIteratorSerializableWithRemovals() throws Exception {
		final String name = "test-iterator";
	...
	@Test
	public void testNonConcurrentIteratorSerializableWithRemovalOfNextElements()
			throws Exception {
