...
/**
 * A runnable that can be used to count the completions of asynchronous removals
 * from ScalableHashMap.
 */
class DoneRemoving implements Runnable {

	/** The ScalableHashMap.noteDoneRemoving field. */
	private static Field noteDoneRemoving = getField(ScalableHashMap.class,
			"noteDoneRemoving");
	...
	/**
	 * The number of completions seen since the last await or init call. Callers
	 * should synchronize on the class when reading or writing.
	 */
	private int count = 0;
	...
	/**
	 * Schedules a task with a unique number to notify that the removal task was
	 * committed.
	 */
	public void run() {
