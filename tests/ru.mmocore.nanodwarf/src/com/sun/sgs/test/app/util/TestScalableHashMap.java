...
public class TestScalableHashMap extends Assert {
	...
	private static final Constructor<ScalableHashMap> scalableHashMapConstructor = getConstructor(
			ScalableHashMap.class, int.class, int.class, int.class, int.class);

	/** The findMinDepthFor method. */
	private static final Method findMinDepthFor = getMethod(
			ScalableHashMap.class, "findMinDepthFor", int.class);

	/** The getMinTreeDepth method. */
	private static final Method getMinTreeDepth = getMethod(
			ScalableHashMap.class, "getMinTreeDepth");

	/** The getMaxTreeDepth method. */
	private static final Method getMaxTreeDepth = getMethod(
			ScalableHashMap.class, "getMaxTreeDepth");

	/** The getAvgTreeDepth method. */
	private static final Method getAvgTreeDepth = getMethod(
			ScalableHashMap.class, "getAvgTreeDepth");

	/** The checkLeafRefs method. */
	private static final Method checkLeafRefs = getMethod(
			ScalableHashMap.class, "checkLeafRefs");
	...
	public void testConstructorNoArg() throws Exception {
		...
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap test = (ScalableHashMap) dataService
						.getBinding("test");
				assertEquals(6, getMaxTreeDepth(test));
	...
	@Test
	public void testConstructorOneArgDepth() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						1);
	...
	@Test
	public void testConstructorOneArgDepth3() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						3);
	...
	@Test
	public void testConstructorOneArgDepth4() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						5);
	...
	public void testConstructorOneArgHighConcurrency() throws Exception {
		for (final int concurrency : new int[] { 256, 1024 }) {
			txnScheduler.runTask(new TestAbstractKernelRunnable() {
				public void run() throws Exception {
					Map<Integer, Integer> map = new ScalableHashMap<Integer, Integer>(
							256);
					map.keySet().iterator();
				}
			}, taskOwner);
	...
	@Test
	public void testMultiParamConstructorBadMinConcurrency() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				try {
	...
	@Test
	public void testMultiParamConstructorBadSplitThreshold() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				try {
	...
	@Test
	public void testMultiParamConstructorBadDirectorySize() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				try {
					createScalableHashMap(Integer.class, Integer.class, 1, 32,
							-1);
					fail("Expected IllegalArgumentException");
				} catch (IllegalArgumentException iae) {
				}
	...
	@Test
	public void testPutAllMisc() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
	...
	@Test
	public void testPutAllNotSerializable() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
	...
	@Test
	public void testPutAllNullItems() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Object, Object> test = new ScalableHashMap<Object, Object>();
				Object nonSerializable = Thread.currentThread();
	...
	@Test
	public void testPutMisc() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
	...
	@Test
	public void testPutNotSerializable() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Object, Object> test = new ScalableHashMap<Object, Object>();
				Object nonSerializable = Thread.currentThread();
	...
	@Test
	public void testPutOldValueNotFound() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testPutOldKeyNotFound() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap test = new ScalableHashMap();
				dataService.setBinding("test", test);
	...
	public void testPutNullKey() throws Exception {
		...
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<String, Integer> test = new ScalableHashMap<String, Integer>(
						16);
				test.put(null, 0);
				control.put(null, 0);
				assertEquals(control, test);
	...
	public void testPutNullValue() throws Exception {
		...
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, String> test = new ScalableHashMap<Integer, String>(
						16);
				test.put(0, null);
				control.put(0, null);
				assertEquals(control, test);
	...
	public void testGetNullValue() throws Exception {
		...
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				assertEquals(null,
						((Map) dataService.getBinding("test")).get(0));
			}
		}, taskOwner);
	}
	...
	@Test
	public void testContainsKeyMisc() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Foo> test = new ScalableHashMap<Integer, Foo>();
	...
	public void testContainsKeyNull() throws Exception {
		...
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				assertTrue(((Map) dataService.getBinding("test"))
						.containsKey(null));
			}
		}, taskOwner);
	}
	...
	@Test
	public void testContainsKeyNullOnEmptyMap() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<String, Integer> test = new ScalableHashMap<String, Integer>(
						16);
		...
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				assertFalse(((Map) dataService.getBinding("test"))
						.containsKey(null));
			}
		}, taskOwner);
	}
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testContainsKeyKeyNotFound() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testContainsKeyValueNotFound() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap test = new ScalableHashMap(16);
				dataService.setBinding("test", test);
	...
	@Test
	public void testContainsKeyOnSplitTree() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						16);
	...
	@Test
	public void testContainsValueMisc() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Foo> test = new ScalableHashMap<Integer, Foo>();
	...
	public void testContainsValueNull() throws Exception {
		...
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = uncheckedCast(dataService
						.getBinding("test"));
				assertTrue(test.containsValue(null));
			}
		}, taskOwner);
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testContainsValueNullEmptyMap() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>();
				dataService.setBinding("test", test);
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testContainsValueValueNotFound() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap test = new ScalableHashMap();
				dataService.setBinding("test", test);
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testContainsValueKeyNotFound() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap test = new ScalableHashMap();
				dataService.setBinding("test", test);
	...
	@Test
	public void testContainsValueNullOnSplitMap() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						16);
	...
	@Test
	public void testContainsValueOnSplitTree() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						16);
	...
	public void testValues() throws Exception {
		...
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ManagedSerializable<Collection<Integer>> ms = uncheckedCast(dataService
						.getBinding("values"));
	...
	@Test
	public void testValuesOnSplitTree() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						16);
	...
	public void testKeySet() throws Exception {
		...
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ManagedSerializable<Set> ms = uncheckedCast(dataService
						.getBinding("keys"));
				Set keys = ms.get();
				assertEquals(controlKeys, keys);
				assertIteratorContains(controlKeys, keys.iterator());
	...
	public void testEntrySet() throws Exception {
		...
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				...
				assertEquals(controlEntries.hashCode(), entries.hashCode());
				dataService.setBinding("entries", new ManagedSerializable(
						entries));
			}
		}, taskOwner);
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
	...
	@Test
	public void testRemoveMisc() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Foo> test = new ScalableHashMap<Integer, Foo>();
	...
	public void testRemoveNullKey() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<String, Integer> test = new ScalableHashMap<String, Integer>(
						16);
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testRemoveKeyNotFound() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap test = new ScalableHashMap();
				dataService.setBinding("test", test);
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testMultipleClearOperations() throws Exception {
		final Map<Integer, Integer> control = new HashMap<Integer, Integer>();
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>();
	...
	@Test
	public void testPutAndGetOnSingleLeaf() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = new ScalableHashMap<Integer, Integer>();
				Map<Integer, Integer> control = new HashMap<Integer, Integer>();
	...
	@Test
	public void testPutAndGetOnSplitTree() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						16);
	...
	@Test
	public void testPutAndRemoveSingleLeaf() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = new ScalableHashMap<Integer, Integer>();
				Map<Integer, Integer> control = new HashMap<Integer, Integer>();
	...
	@Test
	public void testPutAndRemoveLopsidedPositiveKeys() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>();
				Map<Integer, Integer> control = new HashMap<Integer, Integer>();
	...
	@Test
	public void testPutAndRemoveLopsidedNegativeKeys() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>();
				Map<Integer, Integer> control = new HashMap<Integer, Integer>();
	...
	@Test
	public void testPutAndRemoveDoublyLopsided() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>();
				Map<Integer, Integer> control = new HashMap<Integer, Integer>();
	...
	@Test
	public void testPutAndRemoveHalfRandomKeys() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>();
	...
	@Test
	public void testPutAndRemoveHalfNegativeKeys() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>();
				Map<Integer, Integer> control = new LinkedHashMap<Integer, Integer>();
	...
	@Test
	public void testPutAndRemoveOnSplitTree0() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>();
				Map<Integer, Integer> control = new HashMap<Integer, Integer>();
	...
	@Test
	public void testPutAndRemoveOnSplitTree() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						16);
	...
	@Test
	public void testPutAndRemoveOnNoMergeTreeWithNoCollapse() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = createScalableHashMap(
						Integer.class, Integer.class, 1, 8, 2);
				Map<Integer, Integer> control = new HashMap<Integer, Integer>();
	...
	@Test
	public void testPutAndRemoveOnNoMergeTreeWithCollapse() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = createScalableHashMap(
						Integer.class, Integer.class, 1, 8, 4);
				Map<Integer, Integer> control = new HashMap<Integer, Integer>();
	...
	@Test
	public void testRepeatedPutAndRemove() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						1);
	...
	@Test
	public void testRepeatedPutAndRemoveWithNoMergeAndNoCollapse()
			throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = createScalableHashMap(
						Integer.class, Integer.class, 1, 32, 2);
				Map<Integer, Integer> control = new HashMap<Integer, Integer>();
	...
	@Test
	public void testRepeatedPutAndRemoveWithNoMergeAndCollapse()
			throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = createScalableHashMap(
						Integer.class, Integer.class, 1, 32, 4);
				Map<Integer, Integer> control = new HashMap<Integer, Integer>();
	...
	@Test
	public void testPutAndRemoveOnSplitTree5() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						16);
	...
	@Test
	public void testLeafSize() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = new ScalableHashMap<Integer, Integer>();
	...
	@Test
	public void testLeafSizeAfterRemove() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = new ScalableHashMap<Integer, Integer>();
	...
	@Test
	public void testTreeSizeOnSplitTree() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
	...
	@Test
	public void testTreeSizeOnSplitTreeWithRemovals() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				// create a tree with an artificially small leaf size
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testIteratorNotFound() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap test = new ScalableHashMap();
				dataService.setBinding("test", test);
		...
		for (int i = 0; i < 2; i++) {
			...
			txnScheduler.runTask(new TestAbstractKernelRunnable() {
				public void run() throws Exception {
					...
					ManagedSerializable<Iterator> ms = uncheckedCast(dataService
							.getBinding("valuesIter"));
	...
	@Test
	public void testIteratorOnSplitTree() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						16);
	...
	@Test
	public void testIteratorOnSplitTreeWithRemovals() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				// create a tree with an artificially small leaf size
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
	...
	@Test
	public void testKeyIteratorOnSplitMap() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						16);
	...
	@Test
	public void testValuesIteratorOnSplitMap() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						16);
	...
	public void testLeafSerialization() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				...
				ScalableHashMap<Integer, Integer> m = (ScalableHashMap<Integer, Integer>) ois
						.readObject();
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testSplitTreeSerialization() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						16);
	 ...
	 * class, especially in the setValue() method. These should also expose any
	 * bugs in the KeyValuePair class
	 */

	@Test
	public void testOnManagedObjectKeys() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
	...
	@Test
	public void testOnManagedObjectValues() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
	...
	@Test
	public void testOnManagedObjectKeysAndValues() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
	...
	@Test
	public void testSerializableKeysReplacedWithManagedObjects()
			throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
	...
	@Test
	public void testSerializableValuesReplacedWithManagedObjects()
			throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				Map<Foo, Foo> test = new ScalableHashMap<Foo, Foo>();
	...
	public void testConcurrentIterator() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				...
				for (Iterator<Map.Entry<Integer, Integer>> it = test.entrySet()
						.iterator(); it.hasNext();) {
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testConcurrentIteratorSerialization() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						16);
				...
				Iterator<Map.Entry<Integer, Integer>> it = test.entrySet()
						.iterator();
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testConcurrentIteratorWithRemovals() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						16);
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testConcurrentIteratorWithAdditions() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						16);
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testConcurrentIteratorWithReplacements() throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Integer, Integer> test = new ScalableHashMap<Integer, Integer>(
						16);
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testConcurrentIteratorSerializationEqualHashCodes()
			throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Equals, Integer> test = new ScalableHashMap<Equals, Integer>(
						16);
				...
				Iterator<Map.Entry<Equals, Integer>> it = test.entrySet()
						.iterator();
				for (int i = 0; i < a.length / 2; i++) {
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testConcurrentIteratorWithRemovalsEqualHashCodes()
			throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Equals, Integer> test = new ScalableHashMap<Equals, Integer>(
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testConcurrentIteratorWithAdditionsEqualHashCodes()
			throws Exception {
		txnScheduler.runTask(new TestAbstractKernelRunnable() {
			public void run() throws Exception {
				ScalableHashMap<Equals, Integer> test = new ScalableHashMap<Equals, Integer>(
	...
	private static <K, V> ScalableHashMap<K, V> createScalableHashMap(
			Class<K> keyClass, Class<V> valueClass, int minConcurrency,
			int splitThreshold, int directorySize) {
		int minDepth = findMinDepthFor(minConcurrency);
		try {
			return (ScalableHashMap<K, V>) scalableHashMapConstructor
					.newInstance(0, minDepth, splitThreshold, directorySize);
	 ...
	 * collection.
	 */
	private static void assertIteratorContains(Collection<?> contents,
			Iterator<?> iterator) {
	...
	static class Foo implements Serializable {
		...
		public boolean equals(Object o) {
			return o != null && getClass() == o.getClass() && ((Foo) o).i == i;
		}
	}

	/**
	 * A managed object that is equal to objects of the same type with the same
	 * value.
	 */
