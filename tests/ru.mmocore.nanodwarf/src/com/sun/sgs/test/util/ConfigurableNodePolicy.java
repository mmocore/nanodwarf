...
/**
 * A configurable (at runtime) node policy. By default, it always assigns to the
 * local requesting node (i.e., LocalNodePolicy) and round robin assignment is
 * used when the server is making the request due to node failure.
 * <p>
 * 
 * Use the {@link #setRoundRobinPolicy} and {@link #setLocalNodePolicy} methods
...
public class ConfigurableNodePolicy extends RoundRobinPolicy {
	...
	/**
	 * Creates a new instance with the default local node policy. Constructing
	 * an instance of this class resets the default policy for all instances of
	 * this class.
	 * 
	 * @param props
	 *            service properties
	 ...
	 * {@inheritDoc}
	 * <p>
	 * This implementation assigns to the node depending on how this instance is
	 * configured. By default, the policy is the "local node" policy.
	 */
