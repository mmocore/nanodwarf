...
import static com.sun.sgs.impl.service.transaction.TransactionCoordinatorImpl.UNBOUNDED_TIMEOUT_DEFAULT;
...
/**
 * Provides a simple implementation of {@code TransactionProxy} and
 * {@code TransactionCoordinator}, for testing.
 */
public class DummyTransactionProxy implements TransactionCoordinator,
	 ...
	 * transaction, or null to specify that no transaction should be associated.
	 * Also stores itself in the transaction instance, so that the transaction
	 * can clear the current transaction on prepare, commit, or abort.
	 */
	...
	/**
	 * Specifies the service that should be returned for an exact match for the
	 * specified type.
	 */
	 ...
	 * 
	 * @param timeout
	 *            the bounded transaction timeout
	 */
	 ...
	 * 
	 * @param disablePrepareAndCommitOpt
	 *            whether use of {@code prepareAndCommit} should be disabled
	 */
