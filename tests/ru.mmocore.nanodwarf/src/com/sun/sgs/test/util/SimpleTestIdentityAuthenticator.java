...
public class SimpleTestIdentityAuthenticator implements IdentityAuthenticator {
	...
	public static final SystemIdentities allIdentities = new SystemIdentities();
	...
	public static class SystemIdentities {
		// All the identities in the system, on all nodes
		private final Map<String, IdentityInfo> identities = Collections
				.synchronizedMap(new HashMap<String, IdentityInfo>());
