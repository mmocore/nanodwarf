...
public class DummyManagedObject implements ManagedObject, Serializable {
	...
	/**
	 * Sets the value field, calling markForUpdate to note the modification.
	 */
	...
	/**
	 * Sets the referenced DummyManagedObject, calling markForUpdate to note the
	 * modification.
	 */
	...
	public String toString() {
		return "DummyManagedObject[id:" + id
				+ (value != null ? ", value:" + value : "") + ", next:" + next
				+ "]";
	}
}
