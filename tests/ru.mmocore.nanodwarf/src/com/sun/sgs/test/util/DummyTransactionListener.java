...
public class DummyTransactionListener implements TransactionListener {
	 ...
	 */
	public DummyTransactionListener(RuntimeException failBefore,
			RuntimeException failAfter) {
	...
	public synchronized void assertCalledAfter(CalledAfter assertCalledAfter) {
	 ...
	 * specified.
	 */
	public synchronized void assertCalled(boolean assertCalledBefore,
