...
public class DummyProfileCoordinator {
	...
	private static DummyProfileCoordinator instance = new DummyProfileCoordinator();
	...
	private DummyProfileCoordinator() {
		...
		OperationLoggingProfileOpListener listener = new OperationLoggingProfileOpListener(
				props, owner, null);
	...
	public static void startTask() {
		synchronized (lockObject) {
			if (instance != null) {
				try {
					instance.collectorHandle.startTask(task, owner,
