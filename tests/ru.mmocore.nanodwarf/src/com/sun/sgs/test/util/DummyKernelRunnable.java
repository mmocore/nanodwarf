...
/**
 * A utility class that implements the <code>getBaseTaskType</code> method of
 * <code>KernelRunnable</code> to return the name of this class, and implements
 * <code>run</code> to do nothing.
 */
