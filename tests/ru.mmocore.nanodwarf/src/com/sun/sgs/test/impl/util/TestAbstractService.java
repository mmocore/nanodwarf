...
public class TestAbstractService extends TestCase {
	...
	private static final LoggerWrapper logger = new LoggerWrapper(
			Logger.getLogger(TestAbstractService.class.getName()));

	private static final Properties serviceProps = createProperties(
			StandardProperties.APP_NAME, "TestAbstractService");
	...
	public void testConstructorNullComponentRegistry() {
		try {
			new DummyService(serviceProps, null, serverNode.getProxy(), logger);
			fail("expected NullPointerException");
		} catch (NullPointerException e) {
			System.err.println(e);
		}
	...
	public void testCheckServiceVersionMismatchedMajorVersion()
			throws Exception {
		DummyService service = createDummyService();
	...
	public void testCheckServiceVersionMismatchedMinorVersion()
			throws Exception {
		DummyService service = createDummyService();
	...
	public void testReportingLocalFailure() throws Exception {
		final DummyServiceFailureReporter service = new DummyServiceFailureReporter(
	...
	private static class DummyServiceFailureReporter extends AbstractService {
		...
		public void reportLocalFailure() throws IOException {
			WatchdogService svc = txnProxy.getService(WatchdogService.class);
			svc.reportFailure(txnProxy.getService(DataService.class)
					.getLocalNodeId(), this.getClass().getName());
		}
	...
	private class DummyService extends AbstractService {
		...
		void callCheckServiceVersion(final int major, final int minor,
