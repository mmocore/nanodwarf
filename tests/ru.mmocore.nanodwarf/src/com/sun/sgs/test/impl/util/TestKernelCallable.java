...
public class TestKernelCallable {
	...
	public void testCall() throws Exception {
		Integer result = KernelCallable.call(new KernelCallable<Integer>(
				"TestKernelCallable") {
			public Integer call() {
	...
	public void testCallThrowsNonRetryableException() throws Exception {
		KernelCallable.call(new KernelCallable<Integer>("TestKernelCallable") {
			public Integer call() throws Exception {
	...
	public void testCallMoreThanOnce() throws Exception {
		KernelCallable<Integer> callable = new KernelCallable<Integer>(
				"TestKernelCallable") {
			public Integer call() {
				return new Integer(1);
			}
		...
		Integer result = KernelCallable.call(callable, txnScheduler, taskOwner);
		Assert.assertEquals(new Integer(1), result);

		try {
			KernelCallable.call(callable, txnScheduler, taskOwner);
