...
/**
 * A dummy implementation of the data service that implements only the methods
 * that the {@code BindingKeyedMap} and {@code BindingKeyedSet} implementations
 * need.
 */
class DummyDataService extends TreeMap<String, ManagedObject> implements
		DataService {
	private static final long serialVersionUID = 1;

	private final List<Object> removedObjects = new ArrayList<Object>();
	...
	public void removeObject(Object object) {
		...
		if (!removedObjectsContains(object)) {
			System.err.println("removeObject: adding: " + object.toString());
	...
	public String nextServiceBoundName(String name) {
		...
		return name == null ? firstKey() : higherKey(name);
	}
