...
/**
 * Helper class for sample tests. This runnable is run during the profile
 * listener's report method. It checks for a known task owner to know if a
 * sample should have been added, otherwise the sample should not be in the
 * profile report.
 * <p>
...
class SampleReportRunnable implements Runnable {
	...
	public SampleReportRunnable(String sampleName, Identity negativeOwner,
