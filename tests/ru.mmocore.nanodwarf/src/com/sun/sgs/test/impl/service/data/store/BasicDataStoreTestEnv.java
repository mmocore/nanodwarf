...
/**
 * A basic environment for running a {@code DataStore} test. This class emulates
 * the behavior of the {@code Kernel} class in setting up system components.
 */
public class BasicDataStoreTestEnv extends Assert {
	...
	/**
	 * Creates a basic environment for running a {@code DataStore} test, using a
	 * {@link NullAccessCoordinator} by default.
	 * 
	 * @param properties
	 ...
	 * @param properties
	 *            the configuration properties
	 * @param accessCoordinatorClassName
	 *            the class name of the access coordinator to use by default
	 */
	public BasicDataStoreTestEnv(Properties properties,
		...
		try {
			...
			Constructor<? extends AccessCoordinatorHandle> accessCoordCons = Class
					.forName(accessCoordinatorClassName)
			...
			Constructor<? extends TransactionScheduler> txnSchedCons = Class
					.forName("com.sun.sgs.impl.kernel.TransactionSchedulerImpl")
			...
			/* Task scheduler */
			Constructor<? extends TaskScheduler> taskSchedCons = Class
					.forName("com.sun.sgs.impl.kernel.TaskSchedulerImpl")
			...
			Class<? extends ComponentRegistry> sysRegClass = Class.forName(
					"com.sun.sgs.impl.kernel.ComponentRegistryImpl")
