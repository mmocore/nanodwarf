...
/**
 * Tests the isolation that {@link DataStoreImpl} enforces between transactions.
 * The unpredictability of the page-level locking used in the native edition of
 * Berkeley DB makes it difficult to write the test to pass predictably for that
 * environment, so only run it for BDB Java edition.
 */
...
public class TestDataStoreImplTxnIsolation extends BasicTxnIsolationTest {
	 ...
	 * 
	 * setBinding existing WRITE WRITE removeBinding notFound WRITE WRITE
