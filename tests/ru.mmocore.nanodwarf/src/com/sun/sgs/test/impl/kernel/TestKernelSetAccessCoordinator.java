...
public class TestKernelSetAccessCoordinator extends Assert {
	...
	public void testClassNameInvalid() throws Exception {
		...
		try {
			new SgsTestNode("TestKernelSetAccessCoordinator", null, properties);
	...
	public void testNullCoordinator() throws Exception {
		...
		SgsTestNode node = new SgsTestNode("TestKernelSetAccessCoordinator",
				null, properties);
		node.shutdown(false);
	}
	...
	public void testMyAccessCoordinator() throws Exception {
		...
		TransactionScheduler txnScheduler = node.getSystemRegistry()
	...
	public abstract static class AbstractCoordinator extends
			NullAccessCoordinator {
		public AbstractCoordinator(Properties properties,
	...
	static class NonPublicCoordinator extends NullAccessCoordinator {
		public NonPublicCoordinator(Properties properties,
				TransactionProxy txnProxy,
				ProfileCollectorHandle profileCollectorHandle) {
			super(properties, txnProxy, profileCollectorHandle);
		}
	...
	public static class NotImplementingCoordinator {
		public NotImplementingCoordinator(Properties properties,
				TransactionProxy txnProxy,
				ProfileCollectorHandle profileCollectorHandle) {
		}
	}

	public static class MissingConstructorCoordinator extends
			NullAccessCoordinator {
	...
	public static class NonPublicConstructorCoordinator extends
			NullAccessCoordinator {
		NonPublicConstructorCoordinator(Properties properties,
				TransactionProxy txnProxy,
				ProfileCollectorHandle profileCollectorHandle) {
			super(properties, txnProxy, profileCollectorHandle);
		}
	...
	public static class NotHandleCoordinator implements AccessCoordinator {
		NotHandleCoordinator(Properties properties, TransactionProxy txnProxy,
				ProfileCollectorHandle profileCollectorHandle) {
		}
	...
	public static class MyAccessCoordinator extends AbstractAccessCoordinator {
		...
		public MyAccessCoordinator(Properties properties,
				TransactionProxy txnProxy,
				ProfileCollectorHandle profileCollectorHandle) {
		...
		public void notifyNewTransaction(Transaction txn,
				long requestedStartTime, int tryCount) {
		}
