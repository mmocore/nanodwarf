...
public class TestDistLPABuilder extends GraphBuilderTests {
	 ...
	 * 
	 * @param builderName
	 *            the type of graph builder to use
	 */
	...
	public void testDefault() throws Exception {
		...
		try {
			...
			LPADriver newDriver = (LPADriver) finderField.get(newNode
	...
	public void testConstructor1() {
		// empty obj use
		Map<Object, Map<Identity, Long>> objUse = graphBuilder
				.getObjectUseMap();
		Assert.assertNotNull(objUse);
		Assert.assertEquals(0, objUse.size());
		// empty conflicts
		Map<Long, Map<Object, Long>> conflicts = graphBuilder.getConflictMap();
	...
	public void testNoteConflictDetectedBadObjId() throws Throwable {
		...
		Method meth = UtilReflection
				.getMethod(builderClass, "noteConflictDetected", Object.class,
	...
	public void testNoteConflictDetected() throws Exception {
		...
		long nodeId = 99L;
		meth.invoke(builder, obj, nodeId, false);
		Map<Long, Map<Object, Long>> conflictMap = graphBuilder
				.getConflictMap();
