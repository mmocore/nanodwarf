...
/**
 * A regression test for sgs-server issue 129. It's desirable to allow Services
 * to be able to use our app utilities in their constructors.
 */
...
public class TestKernelStartupContext {
	...
	/**
	 * A service used for testing. This service is a system extension and has no
	 * associated manager.
	 */
	public static final class TestService implements Service {

		/**
		 * Constructs a TestService instance, using the Data Manager. Because
		 * the data service is constructed by the kernel before this service, we
		 * expect to be able to reach the data manager.
		 * 
		 * @param properties
		 *            the properties
