...
public class TestAffinityGroupGoodness {
	...
	public void testToyModularityAndJaccard() {
		...
		double modularity = AffinityGroupGoodness.calcModularity(
				builder.getAffinityGraph(), group1);
		...
		modularity = AffinityGroupGoodness.calcModularity(
				builder.getAffinityGraph(), group2);
	...
	public void testZachModularity() {
		...
		double modularity = AffinityGroupGoodness.calcModularity(
				builder.getAffinityGraph(), groups);
	...
	public void testModularityCalc() {
		...
		double modularity = AffinityGroupGoodness.calcModularity(
				builder.getAffinityGraph(), groups);
		System.out.println("Modularity test club partition is " + modularity);
	}
