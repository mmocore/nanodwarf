...
public class TestInt30 extends TestCase {
	...
	public void testReadEOF() throws Exception {
		byte[][] tests = { {}, { 0x44 }, { (byte) 0x81, (byte) 0xff },
				{ (byte) 0xcf, 0x12, 0x34 } };
	...
	public void testValues() throws Exception {
		...
		testValue(0xfedcba, (byte) 0xc0, (byte) 0xfe, (byte) 0xdc, (byte) 0xba);
		testValue(0x1234567, (byte) 0xc1, (byte) 0x23, (byte) 0x45, (byte) 0x67);
		testValue(0x3456789a, (byte) 0xf4, (byte) 0x56, (byte) 0x78,
				(byte) 0x9a);
		testValue(0x3fffffff, (byte) 0xff, (byte) 0xff, (byte) 0xff,
				(byte) 0xff);
	}
	...
	private static void testValue(int n, byte... bytes) throws IOException {
		...
		assertEquals("Wrong encoding:", Arrays.toString(bytes),
