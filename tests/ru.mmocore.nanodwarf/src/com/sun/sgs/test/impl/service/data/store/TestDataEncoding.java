...
public class TestDataEncoding extends TestCase {
	...
	public void testEncodeLong() {
		verifyEncodeDecodeLong(0, b(0x80), zero, zero, zero, zero, zero, zero,
				zero);
		verifyEncodeDecodeLong(-1, b(0x7f), ff, ff, ff, ff, ff, ff, ff);
		verifyEncodeDecodeLong(Long.MIN_VALUE, zero, zero, zero, zero, zero,
				zero, zero, zero);
	...
	public void testEncodeString() {
		...
		verifyEncodeDecodeString("Some weird stuff: \u0123\u1234\u3456",
