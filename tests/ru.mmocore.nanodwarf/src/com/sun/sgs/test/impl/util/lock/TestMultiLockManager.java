...
public class TestMultiLockManager extends TestLockManager {
	...
	/**
	 * For the multi-lock manager, it is OK for the same locker to attempt locks
	...
	public void testDowngradeLockWrongLockManager() {
		MultiLockManager<String> lockManager2 = new MultiLockManager<String>(
	 ...
	 * 
	 * Locker1 Read Locker2 Read Locker1 Write BLOCKED Locker3 Read BLOCKED
	 * Locker1 Abort Locker1 Write DENIED Locker3 Read GRANTED
	 */
	@Test
	 ...
	 * 
	 * Locker1 Write Locker2a Read BLOCKED Locker2b Read BLOCKED Locker1 Abort
	 * Locker2a Read GRANTED Locker2b Read GRANTED
	 */
	@Test
	 ...
	 * 
	 * Locker1 Read Locker2a Write BLOCKED Locker2b Write BLOCKED Locker1 Abort
	 * Locker2a Write GRANTED Locker2b Write GRANTED
	 */
	@Test
	 ...
	 * blocked.
	 * 
	 * Locker1 Read Locker2a Write BLOCKED Locker2b Read DENIED Locker1 Abort
	 ...
	 * blocked.
	 * 
	 * Locker1 Write Locker2a Read BLOCKED Locker2b Write DENIED Locker1 Abort
