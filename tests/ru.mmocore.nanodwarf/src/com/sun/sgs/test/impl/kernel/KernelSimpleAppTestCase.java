...
abstract class KernelSimpleAppTestCase extends TestCase {
	...
	protected void setUp() throws IOException {
		...
		config = createProperties(
				...
				String.valueOf(getPort()), "com.sun.sgs.app.root", dir.toURI()
						.toURL().getPath());
		/* Create logging properties to log at WARNING or higher */
		logging = createProperties(".level", "WARNING", "handlers",
	...
	/**
	 * Creates a process builder for the application, using the config, logging,
	...
	/**
	 * Runs a process specified by a ProcessBuilder, checking standard input and
	 * standard error to determine if the process succeeded.
	 */
