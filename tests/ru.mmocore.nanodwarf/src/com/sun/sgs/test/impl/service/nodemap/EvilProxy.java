...
/**
 * An evil proxy object, which throws a {@link RemoteException} for all
 * {@code NodeMappingServer} methods.
 * 
 */
public class EvilProxy implements InvocationHandler {
	...
	private EvilProxy(Object obj) throws Exception {
		...
		Class<?> serverClass = Class
				.forName("com.sun.sgs.impl.service.nodemap.NodeMappingServer");
	...
	public static synchronized Object proxyFor(Object obj) throws Exception {
		...
		return Proxy.newProxyInstance(objClass.getClassLoader(),
				objClass.getInterfaces(), new EvilProxy(obj));
	}
